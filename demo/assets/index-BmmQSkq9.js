...
`).trim(),bullets:e.slice(t).map(e=>e.replace(/^\s*[•\-\*]\s*/,``).trim()).filter(e=>e.length>0)}});function he(){Ea.update(e=>!e)}var ge=$s(),_e=I(ge),O=e=>{W(e,ks())},ve=e=>{var t=Qs(),n=L(t),r=I(n),i=I(r);let l;var u=I(i),p=e=>{var t=As();Ie(),W(e,t)},b=e=>{var t=js();Ie(),W(e,t)};K(u,e=>{V(d).is_starred?e(p):e(b,-1)}),j(i);var S=R(i,2);let w;var T=R(I(S));j(S);var se=R(S,2),ue=R(se,2),ge=R(I(ue));j(ue);var _e=R(ue,2),O=e=>{var t=Ms(),n=I(t,!0);j(t),z(()=>G(n,V(ie))),W(e,t)};K(_e,e=>{V(ie)&&e(O)});var ve=R(_e,2),ye=I(ve),be=R(ye,2),xe=e=>{var t=Is(),n=I(t),r=e=>{let t=Qt(()=>a().id),n=Qt(()=>o().find(e=>e.id===V(t)));var r=$r(),i=L(r),s=e=>{var t=Ns(),r=L(t),i=I(r);j(r),Ie(2),z(()=>G(i,`Remove from "${V(n).name??``}"`)),H(`click`,r,()=>le(V(n).id,V(n).name)),W(e,t)};K(i,e=>{V(n)&&e(s)}),W(e,r)};K(n,e=>{a().kind===`board`&&e(r)});var i=R(n,2),s=e=>{W(e,Ps())},c=e=>{var t=$r();li(L(t),1,o,e=>e.id,(e,t)=>{var n=Fs(),r=I(n,!0);j(n),z(()=>{Y(n,`data-testid`,`picker-board-${V(t).id??``}`),G(r,V(t).name)}),H(`click`,n,()=>ce(V(t).id,V(t).name)),W(e,n)}),W(e,t)};K(i,e=>{o().length===0?e(s):e(c,-1)}),j(t),W(e,t)};K(be,e=>{V(h)&&e(xe)});var Se=R(be,2),Ce=e=>{var t=Ls(),n=I(t,!0);j(t),z(()=>G(n,V(g))),W(e,t)};K(Se,e=>{V(g)&&e(Ce)}),j(ve);var we=R(ve,2),Te=I(we),Ee=R(Te,2),De=e=>{var t=Rs(),n=I(t);J(n);var r=R(n,2),i=I(r,!0);j(r),Ie(2),j(t),z(e=>{n.disabled=V(y),r.disabled=e,G(i,V(y)?`Muting…`:`Add mute rule`)},[()=>V(y)||!V(v).trim()]),X(n,()=>V(v),e=>F(v,e)),H(`keydown`,n,e=>{e.key===`Enter`&&oe()}),H(`click`,r,oe),W(e,t)};K(Ee,e=>{V(_)&&e(De)}),j(we);var Oe=R(we,4),ke=e=>{var t=zs();z(()=>Y(t,`href`,V(d).url)),W(e,t)};K(Oe,e=>{V(d).url&&e(ke)}),j(r);var Ae=R(r,2),je=I(Ae),Me=I(je,!0);j(je);var k=R(je,2),Ne=I(k,!0);j(k);var A=R(k,2),Pe=e=>{var t=Bs(),n=I(t,!0);j(t),z(e=>G(n,e),[()=>V(d).tags.split(`,`)[0].trim()]),W(e,t)};K(A,e=>{V(d).tags&&e(Pe)});var Fe=R(A,2),Le=e=>{var t=Vs(),n=I(t);j(t),z(()=>G(n,`Also in ${V(d).dup_count+1} feeds`)),W(e,t)};K(Fe,e=>{V(d).dup_count>0&&e(Le)});var Re=R(Fe,2),ze=I(Re);j(Re);var Be=R(Re,2),Ve=e=>{var t=Hs(),n=I(t);j(t),z(e=>G(n,`· ${e??``} min read`),[()=>pe()]),W(e,t)},He=Qt(()=>pe()>0);K(Be,e=>{V(He)&&e(Ve)}),j(Ae);var Ue=R(Ae,2),We=I(Ue,!0);j(Ue);var Ge=R(Ue,2),Ke=I(Ge);li(Ke,16,()=>V(C),e=>e,(e,t)=>{var n=Us(),r=I(n),i=R(r);j(n),z(()=>{G(r,`#${t??``} `),Y(i,`aria-label`,`Remove tag ${t}`),Y(i,`title`,`Remove tag ${t}`)}),H(`click`,i,()=>E(t)),W(e,n)});var qe=R(Ke,2);J(qe),j(Ge);var Je=R(Ge,2),Ye=e=>{var t=Ys(),n=I(t),r=R(I(n),4),i=e=>{var t=Ws(),n=I(t);j(t),z(()=>G(n,`local · ${V(d).summary_model??``}`)),W(e,t)};K(r,e=>{V(d).summary_model&&e(i)});var a=R(r,2),o=I(a),s=R(o);let l;j(a),j(n);var u=R(n,2),f=e=>{var t=Js(),n=I(t),r=I(n),i=e=>{var t=$r();li(L(t),17,()=>V(me).paragraph.split(/\n{2,}/),ai,(e,t)=>{var n=Gs(),r=I(n,!0);j(n),z(()=>G(r,V(t))),W(e,n)}),W(e,t)};K(r,e=>{V(me).paragraph&&e(i)});var a=R(r,2),o=e=>{var t=qs();li(t,21,()=>V(me).bullets,ai,(e,t)=>{var n=Ks(),r=I(n,!0);j(n),z(()=>G(r,V(t))),W(e,n)}),j(t),W(e,t)};K(a,e=>{V(me).bullets.length>0&&e(o)}),j(n),j(t),W(e,t)};K(u,e=>{c()||e(f)}),j(t),z(()=>{Y(a,`aria-expanded`,!c()),G(o,`${c()?`Show`:`Hide`} `),l=q(s,0,`svelte-1hmgvz1`,null,l,{rot:c()})}),H(`click`,a,he),W(e,t)};K(Je,e=>{s()&&(V(me).paragraph||V(me).bullets.length>0)&&e(Ye)});var Xe=R(Je,2),Ze=I(Xe),Qe=e=>{var t=$r();hi(L(t),()=>V(d).content_html),W(e,t)},$e=e=>{var t=$r();hi(L(t),()=>V(d).cleaned_html),W(e,t)},et=e=>{var t=Xs(),n=I(t,!0);j(t),z(()=>G(n,V(d).content_text)),W(e,t)};K(Ze,e=>{V(d).content_html?e(Qe):V(d).cleaned_html?e($e,1):V(d).content_text&&e(et,2)}),j(Xe),j(n);var tt=R(n,2),nt=e=>{Os(e,{get articleId(){return V(d).id},get articleTitle(){return V(d).title},onClose:()=>F(m,!1)})};K(tt,e=>{V(m)&&e(nt)});var rt=R(tt,2),it=e=>{var t=Zs();H(`click`,t,ee),W(e,t)};K(rt,e=>{V(x)&&e(it)}),z((e,t,n)=>{l=q(i,1,`ra-btn svelte-1hmgvz1`,null,l,{starred:V(d).is_starred}),w=q(S,1,`ra-btn svelte-1hmgvz1`,null,w,{starred:V(d).is_later}),G(T,` ${V(d).is_later?`Saved`:`Read later`}`),ue.disabled=V(D),G(ge,` ${V(D)?`Extracting…`:`Re-extract`}`),Si(je,`background:${e??``}`),G(Me,t),G(Ne,V(f)?.title_override||V(f)?.title||``),G(ze,`· ${n??``}`),G(We,V(d).title),Y(qe,`placeholder`,V(C).length===0?`Add tag…`:`+ tag`),qe.disabled=V(ne)},[()=>de(V(d).feed_id),()=>(V(f)?.title||`?`)[0]?.toUpperCase(),()=>fe(V(d).published_at)]),H(`click`,i,()=>Pa(V(d).id,!V(d).is_starred)),H(`click`,S,()=>Fa(V(d).id,!V(d).is_later)),H(`click`,se,()=>F(m,!0)),H(`click`,ue,ae),H(`click`,ye,e=>{e.stopPropagation(),F(h,!V(h))}),H(`click`,Te,e=>{e.stopPropagation(),F(_,!V(_))}),X(qe,()=>V(te),e=>F(te,e)),H(`keydown`,qe,e=>{e.key===`Enter`&&re()}),H(`blur`,qe,()=>V(te).trim()&&re()),W(e,t)};K(_e,e=>{V(d)?e(ve,-1):e(O)}),j(ge),Bi(ge,e=>F(b,e),()=>V(b)),H(`scroll`,ge,S),W(e,ge),Je(),u()}var tc=U(`<button class="mobile-icon-btn svelte-1h259us" aria-label="Back to article list" data-testid="mobile-back"><svg viewBox="0 0 24 24" width="22" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M15 18l-6-6 6-6"></path></svg></button>`),nc=U(`<button class="mobile-icon-btn svelte-1h259us" aria-label="Open sidebar" data-testid="mobile-menu"><svg viewBox="0 0 24 24" width="22" fill="none" stroke="currentColor" stroke-width="2.2"><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg></button>`),rc=U(`<button type="button" class="search-clear svelte-1h259us" aria-label="Clear search" title="Clear search (Esc)" data-testid="search-clear">×</button>`),ic=U(`<span class="kbd svelte-1h259us">/</span>`),ac=Zr(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1h259us"><rect x="3" y="4" width="18" height="16" rx="2"></rect><path d="M9 4v16"></path><path d="M14 12l3-3M14 12l3 3"></path></svg>`),oc=Zr(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1h259us"><rect x="3" y="4" width="18" height="16" rx="2"></rect><path d="M9 4v16"></path></svg>`),sc=Zr(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1h259us"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41"></path></svg>`),cc=Zr(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1h259us"><path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8Z"></path></svg>`),lc=U(`<button class="icon-btn svelte-1h259us" data-testid="toggle-sidebar"><!></button> <button title="Refresh feeds now"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1h259us"><path d="M21 12a9 9 0 1 1-3-6.7L21 8"></path><path d="M21 3v5h-5"></path></svg></button> <button class="icon-btn svelte-1h259us" title="Toggle theme"><!></button>`,1),uc=U(`<span class="who svelte-1h259us"> <small class="svelte-1h259us"> </small></span>`),dc=U(`<span class="avatar svelte-1h259us"> </span> <!>`,1),fc=U(`<a target="_blank" rel="noopener noreferrer" class="svelte-1h259us"> </a>`),pc=U(`<div class="search-results svelte-1h259us" data-search-results="" data-testid="search-results"></div>`),mc=Zr(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1h259us"><circle cx="12" cy="12" r="4"></circle><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41"></path></svg> Switch to light`,1),hc=Zr(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1h259us"><path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8Z"></path></svg> Switch to dark`,1),gc=U(`<button class="pop-item svelte-1h259us" data-testid="mobile-refresh"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1h259us"><path d="M21 12a9 9 0 1 1-3-6.7L21 8"></path><path d="M21 3v5h-5"></path></svg> Refresh feeds</button> <button class="pop-item svelte-1h259us" data-testid="mobile-theme"><!></button> <div class="pop-sep svelte-1h259us"></div>`,1),_c=U(`<div class="popover svelte-1h259us" data-popover="" role="menu"><div class="pop-user svelte-1h259us"><span class="avatar svelte-1h259us"> </span> <div><div class="pop-name svelte-1h259us"> </div> <div class="pop-mail svelte-1h259us"> </div></div></div> <!> <button class="pop-item svelte-1h259us" data-testid="open-settings"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1h259us"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.7 1.7 0 0 0 .4 1.9l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.9-.4 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.6 1.7 1.7 0 0 0-1.9.4l-.1.1A2 2 0 1 1 4.2 17l.1-.1a1.7 1.7 0 0 0 .4-1.9 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.6-1.1 1.7 1.7 0 0 0-.4-1.9l-.1-.1A2 2 0 1 1 7 4.2l.1.1a1.7 1.7 0 0 0 1.9.4H9a1.7 1.7 0 0 0 1-1.5V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.9-.4l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.4 1.9V9a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1Z"></path></svg> Settings</button> <div class="pop-sep svelte-1h259us"></div> <button class="pop-item svelte-1h259us" data-testid="logout"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="svelte-1h259us"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4M16 17l5-5-5-5M21 12H9"></path></svg> Sign out</button></div>`),vc=U(`<header><!> <div class="brand svelte-1h259us"><span class="kite svelte-1h259us" aria-hidden="true"><svg viewBox="0 0 64 64" class="svelte-1h259us"><defs><linearGradient id="brand-emb" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="var(--ember-soft)"></stop><stop offset="1" stop-color="var(--ember)"></stop></linearGradient></defs><circle cx="13" cy="15" r="6.5" fill="url(#brand-emb)"></circle><rect x="25" y="11.5" width="31" height="8" rx="4" fill="var(--ink)"></rect><rect x="8" y="28" width="48" height="8" rx="4" fill="var(--ink)"></rect><rect x="8" y="44.5" width="34" height="8" rx="4" fill="url(#brand-emb)"></rect></svg></span> </div> <form class="search svelte-1h259us" data-search-form=""><svg viewBox="0 0 24 24" width="17" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="11" cy="11" r="7"></circle><path d="M21 21l-4-4"></path></svg> <input data-testid="search-input" class="svelte-1h259us"/> <!></form> <div class="topbar-actions svelte-1h259us"><!> <button data-user-chip=""><!></button></div> <!> <!></header>`);function yc(e,t){qe(t,!0);let n=()=>M(xa,`$branding`,o),r=()=>M(wa,`$sidebarCollapsed`,o),i=()=>M(ga,`$theme`,o),a=()=>M(Xi,`$user`,o),[o,s]=gt(),c=Gi(t,`mobile`,3,!1),l=Gi(t,`showBack`,3,!1),u=P(``),d=P(hn([])),f=P(!1),p=P(!1),m=P(!1);function h(e){let t=e.target;V(p)&&!t.closest(`[data-popover]`)&&!t.closest(`[data-user-chip]`)&&F(p,!1),V(f)&&!t.closest(`[data-search-results]`)&&!t.closest(`[data-search-form]`)&&F(f,!1)}Ki(()=>document.addEventListener(`click`,h)),qi(()=>document.removeEventListener(`click`,h));async function g(e){e.preventDefault();let t=V(u).trim();if(!t){F(d,[],!0),F(f,!1);return}fa.set({kind:`search`,query:t}),Ma({kind:`search`,query:t}),F(f,!1)}function _(){if(F(u,``),F(d,[],!0),F(f,!1),ft(fa).kind===`search`){let e={kind:`smart`,view:`fresh`};fa.set(e),Ma(e)}}let v;function y(){v&&clearTimeout(v);let e=V(u).trim();if(!e){F(d,[],!0),F(f,!1);return}v=setTimeout(async()=>{try{F(d,((await $.search(e,6)).data??[]).map(e=>({id:e.id,title:e.title,url:e.url})),!0),F(f,V(d).length>0)}catch{F(d,[],!0)}},220)}function b(){ga.update(e=>e===`light`?`dark`:`light`)}async function x(){if(!V(m)){F(m,!0);try{await la(),await Ma(ft(fa))}finally{F(m,!1)}}}function S(e){return(e?.[0]??`?`).toUpperCase()}var ee=vc();let C;var te=I(ee),ne=e=>{var n=tc();H(`click`,n,()=>t.onBack?.()),W(e,n)},w=e=>{var n=nc();H(`click`,n,()=>t.onToggleMobileSidebar?.()),W(e,n)};K(te,e=>{c()&&l()?e(ne):c()&&e(w,1)});var T=R(te,2),re=R(I(T));j(T);var E=R(T,2),D=R(I(E),2);J(D);var ie=R(D,2),ae=e=>{var t=rc();H(`click`,t,_),W(e,t)},oe=e=>{W(e,ic())};K(ie,e=>{V(u)?e(ae):e(oe,-1)}),j(E);var se=R(E,2),ce=I(se),le=e=>{var t=lc(),n=L(t),a=I(n),o=e=>{W(e,ac())},s=e=>{W(e,oc())};K(a,e=>{r()?e(o):e(s,-1)}),j(n);var c=R(n,2);let l;var u=R(c,2),d=I(u),f=e=>{W(e,sc())},p=e=>{W(e,cc())};K(d,e=>{i()===`dark`?e(f):e(p,-1)}),j(u),z(()=>{Y(n,`title`,r()?`Show sidebar`:`Hide sidebar`),l=q(c,1,`icon-btn svelte-1h259us`,null,l,{spinning:V(m)})}),H(`click`,n,()=>{wa.update(e=>!e);try{localStorage.setItem(`ember:sidebar`,r()?`closed`:`open`)}catch{}}),H(`click`,c,x),H(`click`,u,b),W(e,t)};K(ce,e=>{c()||e(le)});var ue=R(ce,2);let de;var fe=I(ue),pe=e=>{var t=dc(),n=L(t),r=I(n,!0);j(n);var i=R(n,2),o=e=>{var t=uc(),n=I(t,!0),r=R(n),i=I(r,!0);j(r),j(t),z(()=>{G(n,a().username),G(i,a().is_admin?`Administrator`:`Reader`)}),W(e,t)};K(i,e=>{c()||e(o)}),z(e=>G(r,e),[()=>S(a().username)]),W(e,t)};K(fe,e=>{a()&&e(pe)}),j(ue),j(se);var me=R(se,2),he=e=>{var t=pc();li(t,21,()=>V(d),e=>e.id,(e,t)=>{var n=fc(),r=I(n,!0);j(n),z(()=>{Y(n,`href`,V(t).url||`#`),G(r,V(t).title)}),W(e,n)}),j(t),W(e,t)};K(me,e=>{V(f)&&V(d).length>0&&e(he)});var ge=R(me,2),_e=e=>{var n=_c(),r=I(n),o=I(r),s=I(o,!0);j(o);var l=R(o,2),u=I(l),d=I(u,!0);j(u);var f=R(u,2),m=I(f,!0);j(f),j(l),j(r);var h=R(r,2),g=e=>{var t=gc(),n=L(t),r=R(n,2),a=I(r),o=e=>{var t=mc();Ie(),W(e,t)},s=e=>{var t=hc();Ie(),W(e,t)};K(a,e=>{i()===`dark`?e(o):e(s,-1)}),j(r),Ie(2),H(`click`,n,()=>{F(p,!1),x()}),H(`click`,r,()=>{F(p,!1),b()}),W(e,t)};K(h,e=>{c()&&e(g)});var _=R(h,2),v=R(_,4);j(n),z(e=>{G(s,e),G(d,a()?.username),G(m,a()?.email||`—`)},[()=>S(a()?.username??``)]),H(`click`,_,()=>{F(p,!1),t.onOpenSettings()}),H(`click`,v,()=>{F(p,!1),na()}),W(e,n)};K(ge,e=>{V(p)&&e(_e)}),j(ee),z(()=>{C=q(ee,1,`topbar svelte-1h259us`,null,C,{mobile:c()}),G(re,` ${n().name??``}`),Y(D,`placeholder`,c()?`Search…`:`Search all articles, sources, and notes…`),de=q(ue,1,`user-chip svelte-1h259us`,null,de,{"icon-only":c()}),Y(ue,`aria-label`,c()?`Account menu`:void 0)}),X(D,()=>V(u),e=>F(u,e)),H(`input`,D,y),H(`keydown`,D,e=>{e.key===`Escape`&&_()}),H(`submit`,E,g),H(`click`,ue,()=>F(p,!V(p))),W(e,ee),Je(),s()}var bc=U(`<tr><td class="svelte-11xj8pj"><kbd class="svelte-11xj8pj"> </kbd></td><td class="svelte-11xj8pj"> </td></tr>`),xc=U(`<div class="backdrop svelte-11xj8pj" role="dialog" aria-modal="true" aria-labelledby="shortcut-help-title" data-testid="shortcut-help"><div class="card svelte-11xj8pj"><header class="svelte-11xj8pj"><h2 id="shortcut-help-title" class="svelte-11xj8pj">Keyboard shortcuts</h2> <button class="close svelte-11xj8pj" aria-label="Close">×</button></header> <table class="svelte-11xj8pj"><tbody></tbody></table></div></div>`);function Sc(e,t){qe(t,!0);let n=[[`j`,`Next article`],[`k`,`Previous article`],[`m`,`Toggle read on selected article`],[`s`,`Toggle star on selected article`],[`o`,`Open original article in a new tab`],[`r`,`Refresh sidebar + article list`],[`/`,`Focus the search bar`],[`?`,`Show this help`],[`Esc`,`Close this help`]];function r(e){e.key===`Escape`&&(e.preventDefault(),t.onClose())}Ki(()=>window.addEventListener(`keydown`,r)),qi(()=>window.removeEventListener(`keydown`,r));var i=xc(),a=I(i),o=I(a),s=R(I(o),2);j(o);var c=R(o,2),l=I(c);li(l,21,()=>n,ai,(e,t)=>{var n=Qt(()=>h(V(t),2));let r=()=>V(n)[0],i=()=>V(n)[1];var a=bc(),o=I(a),s=I(o),c=I(s,!0);j(s),j(o);var l=R(o),u=I(l,!0);j(l),j(a),z(()=>{G(c,r()),G(u,i())}),W(e,a)}),j(l),j(c),j(a),j(i),H(`click`,s,function(...e){t.onClose?.apply(this,e)}),H(`click`,a,Vi(function(e){Wi.call(this,t,e)})),H(`click`,i,function(...e){t.onClose?.apply(this,e)}),W(e,i),Je()}var Cc=U(`<p class="error svelte-19cjzvl" data-testid="filter-error"> </p>`),wc=U(`<button type="button" class="ghost svelte-19cjzvl">Cancel</button>`),Tc=U(`<p class="muted svelte-19cjzvl">Loading…</p>`),Ec=U(`<p class="muted svelte-19cjzvl">No filters yet.</p>`),Dc=U(`<li class="svelte-19cjzvl"><div class="info svelte-19cjzvl"><strong> </strong> <span class="rule svelte-19cjzvl"> </span> <span class="action svelte-19cjzvl"> </span></div> <div class="row-actions svelte-19cjzvl"><button type="button" class="ghost svelte-19cjzvl"> </button> <button type="button" class="ghost svelte-19cjzvl">Edit</button> <button type="button" class="ghost danger svelte-19cjzvl">Delete</button></div></li>`),Oc=U(`<ul class="svelte-19cjzvl"></ul>`),kc=U(`<div class="backdrop svelte-19cjzvl" role="dialog" aria-modal="true" aria-labelledby="filter-manager-title" data-testid="filter-manager"><div class="modal svelte-19cjzvl"><header class="svelte-19cjzvl"><h2 id="filter-manager-title" class="svelte-19cjzvl">Filters</h2> <button class="close svelte-19cjzvl" aria-label="Close">×</button></header> <!> <section class="form svelte-19cjzvl" aria-label="New or edit filter"><label class="svelte-19cjzvl"><span>Name</span> <input placeholder="Hide crypto news" data-testid="filter-name" class="svelte-19cjzvl"/></label> <div class="row svelte-19cjzvl"><label class="svelte-19cjzvl"><span>Field</span> <select data-testid="filter-field" class="svelte-19cjzvl"><option>Title</option><option>Content</option><option>Author</option><option>URL</option></select></label> <label class="svelte-19cjzvl"><span>Op</span> <select data-testid="filter-op" class="svelte-19cjzvl"><option>contains</option><option>equals</option><option>starts with</option><option>matches (regex)</option></select></label></div> <label class="svelte-19cjzvl"><span>Value</span> <input placeholder="crypto" data-testid="filter-value" class="svelte-19cjzvl"/></label> <label class="checkbox svelte-19cjzvl"><input type="checkbox" class="svelte-19cjzvl"/> <span>Case sensitive</span></label> <div class="row svelte-19cjzvl"><label class="svelte-19cjzvl"><span>Action</span> <select data-testid="filter-action" class="svelte-19cjzvl"><option>Mark read</option><option>Star</option><option>Hide (mark read)</option></select></label> <label class="checkbox svelte-19cjzvl"><input type="checkbox" class="svelte-19cjzvl"/> <span>Enabled</span></label></div> <div class="actions svelte-19cjzvl"><!> <button type="button" data-testid="filter-save" class="svelte-19cjzvl"> </button></div></section> <hr class="svelte-19cjzvl"/> <section class="list svelte-19cjzvl"><!></section></div></div>`);function Ac(e,t){qe(t,!0);let n=P(hn([])),r=P(!1),i=P(``),a=()=>({id:null,name:``,field:`title`,op:`contains`,value:``,case_sensitive:!1,action:`mark_read`,enabled:!0}),o=P(hn(a()));async function s(){F(r,!0),F(i,``);try{F(n,(await $.listFilters()).data??[],!0)}catch(e){F(i,e instanceof Z?e.message:String(e),!0)}finally{F(r,!1)}}Ki(s);function c(e){let t=JSON.parse(e.match_json);F(o,{id:e.id,name:e.name,field:t.field,op:t.op,value:t.value,case_sensitive:t.case_sensitive??!1,action:e.action,enabled:e.enabled},!0)}async function l(){oo()}async function u(e){try{await $.deleteFilter(e),await s()}catch(e){F(i,e instanceof Z?e.message:String(e),!0)}}async function d(e){try{await $.updateFilter(e.id,{enabled:!e.enabled}),await s()}catch(e){F(i,e instanceof Z?e.message:String(e),!0)}}function f(e){try{let t=JSON.parse(e.match_json);return`${t.field} ${t.op} "${t.value}"`}catch{return e.match_json}}var p=kc(),m=I(p),h=I(m),g=R(I(h),2);j(h);var _=R(h,2),v=e=>{var t=Cc(),n=I(t,!0);j(t),z(()=>G(n,V(i))),W(e,t)};K(_,e=>{V(i)&&e(v)});var y=R(_,2),b=I(y),x=R(I(b),2);J(x),j(b);var S=R(b,2),ee=I(S),C=R(I(ee),2),te=I(C);te.value=te.__value=`title`;var ne=R(te);ne.value=ne.__value=`content`;var w=R(ne);w.value=w.__value=`author`;var T=R(w);T.value=T.__value=`url`,j(C),j(ee);var re=R(ee,2),E=R(I(re),2),D=I(E);D.value=D.__value=`contains`;var ie=R(D);ie.value=ie.__value=`equals`;var ae=R(ie);ae.value=ae.__value=`starts_with`;var oe=R(ae);oe.value=oe.__value=`matches`,j(E),j(re),j(S);var se=R(S,2),ce=R(I(se),2);J(ce),j(se);var le=R(se,2),ue=I(le);J(ue),Ie(2),j(le);var de=R(le,2),fe=I(de),pe=R(I(fe),2),me=I(pe);me.value=me.__value=`mark_read`;var he=R(me);he.value=he.__value=`star`;var ge=R(he);ge.value=ge.__value=`hide`,j(pe),j(fe);var _e=R(fe,2),O=I(_e);J(O),Ie(2),j(_e),j(de);var ve=R(de,2),ye=I(ve),be=e=>{var t=wc();H(`click`,t,()=>F(o,a(),!0)),W(e,t)};K(ye,e=>{V(o).id!==null&&e(be)});var xe=R(ye,2),Se=I(xe,!0);j(xe),j(ve),j(y);var Ce=R(y,4),we=I(Ce),Te=e=>{W(e,Tc())},Ee=e=>{W(e,Ec())},De=e=>{var t=Oc();li(t,21,()=>V(n),e=>e.id,(e,t)=>{var n=Dc(),r=I(n),i=I(r),a=I(i,!0);j(i);var o=R(i,2),s=I(o,!0);j(o);var l=R(o,2),p=I(l);j(l),j(r);var m=R(r,2),h=I(m),g=I(h,!0);j(h);var _=R(h,2),v=R(_,2);j(m),j(n),z(e=>{Y(n,`data-testid`,`filter-row-${V(t).id??``}`),G(a,V(t).name),G(s,e),G(p,`→ ${V(t).action??``}`),G(g,V(t).enabled?`Disable`:`Enable`)},[()=>f(V(t))]),H(`click`,h,()=>d(V(t))),H(`click`,_,()=>c(V(t))),H(`click`,v,()=>u(V(t).id)),W(e,n)}),j(t),W(e,t)};K(we,e=>{V(r)?e(Te):V(n).length===0?e(Ee,1):e(De,-1)}),j(Ce),j(m),j(p),z(()=>G(Se,V(o).id===null?`Add filter`:`Save changes`)),H(`click`,g,function(...e){t.onClose?.apply(this,e)}),X(x,()=>V(o).name,e=>V(o).name=e),Ti(C,()=>V(o).field,e=>V(o).field=e),Ti(E,()=>V(o).op,e=>V(o).op=e),X(ce,()=>V(o).value,e=>V(o).value=e),Ii(ue,()=>V(o).case_sensitive,e=>V(o).case_sensitive=e),Ti(pe,()=>V(o).action,e=>V(o).action=e),Ii(O,()=>V(o).enabled,e=>V(o).enabled=e),H(`click`,xe,l),H(`click`,m,Vi(function(e){Wi.call(this,t,e)})),H(`click`,p,function(...e){t.onClose?.apply(this,e)}),W(e,p),Je()}var jc=U(`<button class="back-btn svelte-1u3w06f" aria-label="Back to settings menu" data-testid="settings-back"><svg viewBox="0 0 24 24" width="22" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M15 18l-6-6 6-6"></path></svg></button> <h2 id="settings-title" class="svelte-1u3w06f"> </h2>`,1),Mc=U(`<h2 id="settings-title" class="svelte-1u3w06f">Settings</h2>`),Nc=U(`<div class="nav-group svelte-1u3w06f"><div class="nav-label svelte-1u3w06f">Administration</div> <button data-testid="settings-llm">Language model</button> <button data-testid="settings-branding">Branding</button> <button data-testid="settings-database">Database</button> <button data-testid="settings-session">Sessions</button> <button data-testid="settings-email">Email / SMTP</button> <button data-testid="settings-users">Users</button></div>`),Pc=U(`<p class="error svelte-1u3w06f" data-testid="pw-error"> </p>`),Fc=U(`<p class="ok svelte-1u3w06f" data-testid="pw-msg"> </p>`),Ic=U(`<h3 class="svelte-1u3w06f">Profile</h3> <div class="row svelte-1u3w06f"><label class="svelte-1u3w06f"><span class="svelte-1u3w06f">Username</span> <input type="text" disabled="" class="svelte-1u3w06f"/></label> <label class="svelte-1u3w06f"><span class="svelte-1u3w06f">Email</span> <input type="email" disabled="" placeholder="not set" class="svelte-1u3w06f"/></label></div> <p class="hint svelte-1u3w06f">Email is managed by your administrator.</p> <h4 class="svelte-1u3w06f">Change password</h4> <!> <!> <label class="svelte-1u3w06f"><span class="svelte-1u3w06f">Current password</span> <input type="password" autocomplete="current-password" data-testid="pw-old" class="svelte-1u3w06f"/></label> <label class="svelte-1u3w06f"><span class="svelte-1u3w06f">New password</span> <input type="password" autocomplete="new-password" data-testid="pw-new" class="svelte-1u3w06f"/></label> <label class="svelte-1u3w06f"><span class="svelte-1u3w06f">Confirm new password</span> <input type="password" autocomplete="new-password" class="svelte-1u3w06f"/></label> <div class="actions svelte-1u3w06f"><button data-testid="pw-submit" class="svelte-1u3w06f"> </button></div>`,1),Lc=U(`<p class="hint svelte-1u3w06f">Your browser doesn't support passkeys.</p>`),Rc=U(`<p class="error svelte-1u3w06f"> </p>`),zc=U(`<p class="ok svelte-1u3w06f"> </p>`),Bc=U(`<p class="hint svelte-1u3w06f">No passkeys registered yet.</p>`),Vc=U(`<li class="list-row"><div><div class="list-title"> </div> <div class="list-sub"> <!></div></div> <button class="btn-danger">Remove</button></li>`),Hc=U(`<ul class="list"></ul>`),Uc=U(`<p class="hint svelte-1u3w06f">Passkeys let you sign in without a password using a fingerprint, face scan, or
            ...
            Set to <code>0</code> to disable the gate and ingest a feed's full upstream history.</p> <label class="svelte-1u3w06f">Hours <input type="number" min="0" max="8760" data-testid="backlog-hours" style="width:140px;" class="svelte-1u3w06f"/></label> <div class="actions svelte-1u3w06f" style="margin-top:12px;"><button data-testid="backlog-save" class="svelte-1u3w06f"> </button></div>`,1),su=U(`<a class="version-badge svelte-1u3w06f" target="_blank" rel="noopener noreferrer" data-testid="about-version"> </a>`),cu=U(`<span class="version-badge version-badge-dev svelte-1u3w06f" data-testid="about-version"> </span>`),lu=U(`<h3 class="svelte-1u3w06f">About</h3> <dl class="kv svelte-1u3w06f"><dt class="svelte-1u3w06f">Version</dt> <dd class="svelte-1u3w06f"><!></dd> <dt class="svelte-1u3w06f">Project</dt><dd class="svelte-1u3w06f"><a href="https://github.com/brandonhon/ember" target="_blank" rel="noopener noreferrer" class="svelte-1u3w06f">github.com/brandonhon/ember</a></dd> <dt class="svelte-1u3w06f">License</dt><dd class="svelte-1u3w06f"><a href="https://github.com/brandonhon/ember/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" class="svelte-1u3w06f">MIT</a></dd></dl>`,1),uu=U(`<div class="backdrop svelte-1u3w06f" role="dialog" aria-modal="true" aria-labelledby="settings-title" data-testid="settings"><div><header class="svelte-1u3w06f"><!> <button class="close svelte-1u3w06f" aria-label="Close">×</button></header> <div class="layout svelte-1u3w06f"><nav class="nav svelte-1u3w06f" aria-label="Settings sections"><div class="nav-group svelte-1u3w06f"><div class="nav-label svelte-1u3w06f">Account</div> <button data-testid="settings-profile">Profile</button> <button data-testid="settings-passkeys">Passkeys</button></div> <div class="nav-group svelte-1u3w06f"><div class="nav-label svelte-1u3w06f">Reading</div> <button>Preferences</button> <button>Filters</button> <button data-testid="settings-digest">Daily digest</button> <button data-testid="settings-stats">Reading stats</button> <button>Mobile clients</button></div> <div class="nav-group svelte-1u3w06f"><div class="nav-label svelte-1u3w06f">Import &amp; Data</div> <button data-testid="settings-import">Import &amp; migrate</button> <button data-testid="settings-starter">Starter packs</button></div> <!> <div class="nav-group svelte-1u3w06f"><div class="nav-label svelte-1u3w06f">System</div> <button>About</button></div></nav> <div class="content svelte-1u3w06f"><!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!></div></div></div> <!> <!></div>`);function du(e,t){qe(t,!0);let n=()=>M(xa,`$branding`,d),r=()=>M(fa,`$activeView`,d),i=()=>M(Xi,`$user`,d),a=()=>M(ga,`$theme`,d),o=()=>M(Ca,`$density`,d),s=()=>M(Zi,`$feverAPIKey`,d),c=()=>M(ya,`$customPalette`,d),l=()=>M(Ta,`$showSummary`,d),u=()=>M(Qi,`$appVersion`,d),[d,f]=gt(),p=P(null),m=P(!1);async function h(){if(V(p)){F(m,!0);try{await V(p).run(),F(p,null)}finally{F(m,!1)}}}let g=P(`profile`),_=P(hn(typeof window<`u`&&window.matchMedia?.(`(max-width: 900px)`).matches)),v=P(!1);Vn(()=>{if(typeof window>`u`)return;let e=window.matchMedia(`(max-width: 900px)`),t=e=>{F(_,e.matches,!0),e.matches||F(v,!1)};return e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)});function y(e){F(g,e,!0),V(_)&&F(v,!0)}function b(){F(v,!1)}let x=P(`live`),S=P(``),ee=P(``),C=P(``),te=P(!0),ne=P(!0),w=P(!1),T=P(``),re=P(``),E=P(void 0),D=P(void 0);async function ie(){if(!V(S).trim()||!V(ee).trim()){F(re,`URL and username are required`);return}if(!V(te)&&!V(ne)){F(re,`Pick at least one of Starred / Archived`);return}F(re,``),F(T,``),F(w,!0);try{let e=await $.importTTRSSAPI({url:V(S).trim(),username:V(ee).trim(),password:V(C),import_starred:V(te),import_archived:V(ne)});F(T,`Imported ${e.data.imported} of ${e.data.total} articles.`),await la()}catch(e){F(re,e instanceof Z?e.message:String(e),!0)}finally{F(w,!1)}}async function ae(e){let t=e.currentTarget,n=t.files?.[0];if(n){F(re,``),F(T,`Importing…`),F(w,!0);try{let e=await $.importTTRSS(n);F(T,`Imported ${e.data.imported} of ${e.data.total} articles.`),await la()}catch(e){F(re,e instanceof Z?e.message:String(e),!0),F(T,``)}finally{t.value=``,F(w,!1)}}}async function oe(e){let t=e.currentTarget,n=t.files?.[0];if(n){F(re,``),F(T,`Importing…`),F(w,!0);try{F(T,`Imported ${(await $.importOPML(n)).data.imported} subscriptions.`),await la()}catch(e){F(re,e instanceof Z?e.message:String(e),!0),F(T,``)}finally{t.value=``,F(w,!1)}}}async function se(){try{let e=await(await $.exportOPML()).blob(),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`ember.opml`,n.click(),URL.revokeObjectURL(t)}catch(e){F(re,e instanceof Z?e.message:String(e),!0)}}let ce=Qt(()=>{switch(V(g)){case`profile`:return`Profile`;case`passkeys`:return`Passkeys`;case`preferences`:return`Preferences`;case`mobile`:return`Mobile clients`;case`filters`:return`Filters`;case`stats`:return`Reading stats`;case`digest`:return`Daily digest`;case`starter`:return`Starter packs`;case`import`:return`Import & migrate`;case`llm`:return`Language model`;case`branding`:return`Branding`;case`database`:return`Database`;case`session`:return`Sessions`;case`email`:return`Email / SMTP`;case`users`:return`Users`;case`about`:return`About`}}),le=P(null),ue=P(``),de=P(``),fe=P(!1);async function pe(){F(ue,``);try{F(le,(await $.getDigest()).data,!0)}catch(e){F(ue,e instanceof Z?e.message:String(e),!0)}}async function me(){if(V(le)){F(fe,!0),F(de,``),F(ue,``);try{F(le,(await $.setDigest(V(le))).data,!0),F(de,`Saved`)}catch(e){F(ue,e instanceof Z?e.message:String(e),!0)}finally{F(fe,!1),setTimeout(()=>F(de,``),3e3)}}}let he=P(null),ge=P(``);async function _e(){F(ge,``);try{F(he,(await $.getStats()).data,!0)}catch(e){F(ge,e instanceof Z?e.message:String(e),!0)}}let O=P(null),ve=P(``),ye=P(``),be=P(``),xe=P(90);async function Se(){F(ve,``);try{let e=await $.getDBStatus();F(O,e.data,!0),F(xe,e.data.cleanup_older_days||90,!0)}catch(e){F(ve,e instanceof Z?e.message:String(e),!0)}}async function Ce(){F(be,`backup`),F(ye,``),F(ve,``);try{await $.dbBackup(),await Se(),F(ye,`Backup created`)}catch(e){F(ve,e instanceof Z?e.message:String(e),!0)}finally{F(be,``),setTimeout(()=>F(ye,``),3e3)}}function we(){F(p,{title:`Clean up old articles?`,message:`Permanently delete articles older than ${V(xe)} days that aren't starred, in a board, or saved for later. The database file is compacted afterwards.`,confirmLabel:`Clean up`,destructive:!0,run:()=>Te()},!0)}async function Te(){F(be,`cleanup`),F(ye,``),F(ve,``);try{let{articles_deleted:e,bytes_reclaimed:t}=(await $.dbCleanup(V(xe))).data;F(ye,`Deleted ${e} articles, reclaimed ${(t/(1024*1024)).toFixed(1)} MiB`),await Se()}catch(e){F(ve,e instanceof Z?e.message:String(e),!0)}finally{F(be,``),setTimeout(()=>F(ye,``),5e3)}}async function Ee(){if(V(O)){F(be,`schedule`),F(ye,``),F(ve,``);try{await $.dbSchedule({backup_schedule:V(O).backup_schedule,backup_keep_count:V(O).backup_keep_count,cleanup_schedule:V(O).cleanup_schedule,cleanup_older_days:V(O).cleanup_older_days,opml_schedule:V(O).opml_schedule||`off`}),F(ye,`Schedule saved`)}catch(e){F(ve,e instanceof Z?e.message:String(e),!0)}finally{F(be,``),setTimeout(()=>F(ye,``),3e3)}}}function De(e){if(!e)return`—`;let t=e/(1024*1024*1024);return t>=1?t.toFixed(2)+` GiB`:(e/(1024*1024)).toFixed(1)+` MiB`}function Oe(e){return e?new Date(e*1e3).toLocaleString():``}let ke=P(hn({name:``,page_title:``,favicon_url:``})),Ae=P(``),je=P(``),Me=P(!1);function k(){F(ke,{name:n().name,page_title:n().page_title,favicon_url:n().favicon_url},!0)}async function Ne(){F(Me,!0),F(Ae,``),F(je,``);try{await $.setBranding(V(ke)),await Sa(),F(Ae,`Saved`)}catch(e){F(je,e instanceof Z?e.message:String(e),!0)}finally{F(Me,!1),setTimeout(()=>F(Ae,``),3e3)}}async function A(){F(ke,{name:``,page_title:``,favicon_url:``},!0),await Ne(),k()}let Pe=P(hn([])),Fe=P(``),Le=P(``),Re=P(``);function ze(e){return e.subscribed>=e.feed_urls.length}async function Be(){try{F(Pe,(await $.listStarterPacks()).data??[],!0)}catch(e){F(Re,e instanceof Z?e.message:String(e),!0)}}async function Ve(e){F(Fe,e,!0),F(Le,``),F(Re,``);try{let t=(await $.importStarterPack(e)).data,n=[];t.feeds_added&&n.push(`${t.feeds_added} added`),t.already_had&&n.push(`${t.already_had} already subscribed`),t.failed_urls?.length&&n.push(`${t.failed_urls.length} failed`),F(Le,n.join(` · `)||`Nothing to add`,!0),await la(),await Ma(r()),setTimeout(()=>{la()},2e3),await Be()}catch(e){F(Re,e instanceof Z?e.message:String(e),!0)}finally{F(Fe,``),setTimeout(()=>F(Le,``),4e3)}}async function He(e){if(confirm(`Unsubscribe from every feed in this pack? Feeds you have starred articles in are not deleted.`)){F(Fe,e,!0),F(Le,``),F(Re,``);try{let t=(await $.removeStarterPack(e)).data,n=[];t.feeds_removed&&n.push(`${t.feeds_removed} removed`),t.not_subscribed&&n.push(`${t.not_subscribed} not subscribed`),t.category_removed&&n.push(`folder cleared`),F(Le,n.join(` · `)||`Nothing to remove`,!0),await la(),await Be()}catch(e){F(Re,e instanceof Z?e.message:String(e),!0)}finally{F(Fe,``),setTimeout(()=>F(Le,``),4e3)}}}let Ue=P(null),We=P(``),Ge=P(``),Ke=P(``),Ye=P(``);async function Xe(){F(We,``);try{F(Ue,(await $.getLLMStatus()).data,!0),!V(Ye)&&V(Ue)?.recommended?.model&&F(Ye,V(Ue).recommended.model,!0)}catch(e){F(We,e instanceof Z?e.message:String(e),!0)}}async function Ze(e){F(Ke,`switch:`+e),F(Ge,``),F(We,``);try{await $.setLLMModel(e),F(Ge,`Now using ${e}`),await Xe()}catch(e){F(We,e instanceof Z?e.message:String(e),!0)}finally{F(Ke,``),setTimeout(()=>F(Ge,``),3e3)}}function Qe(e){F(p,{title:`Delete model?`,message:`Remove "${e}" from local storage. The model files are deleted from Ollama's cache.`,confirmLabel:`Delete`,destructive:!0,run:()=>$e(e)},!0)}async function $e(e){F(Ke,`delete:`+e),F(Ge,``),F(We,``);try{await $.deleteLLMModel(e),F(Ge,`Deleted ${e}`),await Xe()}catch(e){F(We,e instanceof Z?e.message:String(e),!0)}finally{F(Ke,``),setTimeout(()=>F(Ge,``),3e3)}}let et=P(0),tt=P(0),nt=P(0),rt=P(!1),it=P(``);function at(){V(Ue)&&(F(et,V(Ue).options?.temperature??0,!0),F(tt,V(Ue).options?.top_p??0,!0),F(nt,V(Ue).options?.num_ctx??0,!0))}async function ot(){F(rt,!0),F(We,``),F(it,``);try{await $.setLLMOptions({temperature:Number(V(et))||0,top_p:Number(V(tt))||0,num_ctx:Number(V(nt))||0}),F(it,`Saved`),await Xe()}catch(e){F(We,e instanceof Z?e.message:String(e),!0)}finally{F(rt,!1),setTimeout(()=>F(it,``),3e3)}}Vn(()=>{at()});async function st(){let e=V(Ye).trim();if(e){F(Ke,`pull:`+e),F(Ge,``),F(We,``);try{await $.pullLLMModel(e),F(Ge,`Pulled ${e}`),await Xe()}catch(e){F(We,e instanceof Z?e.message:String(e),!0)}finally{F(Ke,``),setTimeout(()=>F(Ge,``),4e3)}}}function ct(e){return e?(e/(1024*1024*1024)).toFixed(1)+` GiB`:`—`}function lt(e){return e?(e/(1024*1024)).toFixed(0)+` MiB`:`—`}let ut=ro(),dt=P(hn([])),ft=P(``),pt=P(``),mt=P(``),ht=P(``);async function _t(){F(ft,``);try{F(dt,(await $.listPasskeys()).data??[],!0)}catch(e){F(ft,e instanceof Z?e.message:String(e),!0)}}async function yt(){F(mt,`register`),F(ft,``),F(pt,``);try{let e=await $.passkeyRegisterBegin(),t=await to(e.data.options),n=V(ht).trim()||`Passkey`;await $.passkeyRegisterFinish(e.data.session_id,n,t),F(ht,``),F(pt,`Passkey added`),await _t()}catch(e){e instanceof Z?F(ft,e.message||`Registration failed`,!0):e instanceof DOMException?F(ft,`Registration cancelled`):F(ft,String(e),!0)}finally{F(mt,``),setTimeout(()=>F(pt,``),3e3)}}function bt(e){F(p,{title:`Remove passkey?`,message:`Devices using "${e.name}" won't be able to sign in with it anymore.`,confirmLabel:`Remove`,destructive:!0,run:()=>xt(e.id)},!0)}async function xt(e){F(mt,`delete:`+e),F(ft,``);try{await $.deletePasskey(e),await _t()}catch(e){F(ft,e instanceof Z?e.message:String(e),!0)}finally{F(mt,``)}}Vn(()=>{V(g)===`starter`&&Be(),V(g)===`llm`&&i()?.is_admin&&Xe(),V(g)===`branding`&&i()?.is_admin&&k(),V(g)===`database`&&i()?.is_admin&&Se(),V(g)===`session`&&i()?.is_admin&&Et(),V(g)===`email`&&i()?.is_admin&&It(),V(g)===`users`&&i()?.is_admin&&an(),V(g)===`stats`&&_e(),V(g)===`digest`&&pe(),V(g)===`passkeys`&&_t()});let N=P(null),St=P(86400),Ct=P(``),wt=P(``),Tt=P(!1);async function Et(){F(wt,``);try{let e=await $.getSessionTTL();F(N,e.data,!0),F(St,e.data.ttl_seconds,!0)}catch(e){F(wt,e instanceof Z?e.message:String(e),!0)}}async function Dt(){F(Tt,!0),F(Ct,``),F(wt,``);try{F(N,(await $.setSessionTTL(V(St))).data,!0),F(Ct,`Saved`)}catch(e){F(wt,e instanceof Z?e.message:String(e),!0)}finally{F(Tt,!1),setTimeout(()=>F(Ct,``),3e3)}}let Ot=[{label:`1 hour`,seconds:3600},{label:`4 hours`,seconds:14400},{label:`24 hours (default)`,seconds:86400},{label:`7 days`,seconds:604800},{label:`30 days`,seconds:2592e3}];Ki(()=>{typeof location<`u`&&location.hash===`#starter`&&F(g,`starter`)});let kt=P(hn({host:``,port:587,username:``,password:``,clear_password:!1,from:``,starttls:!0,initial_backlog_hours:48})),At=P(null),jt=P(!1),Mt=P(``),Nt=P(``),Pt=P(``),Ft=P(!1);async function It(){F(Nt,``);try{let e=await $.getAdminSettings();F(At,e.data,!0),F(kt,{host:e.data.smtp.host,port:e.data.smtp.port,username:e.data.smtp.username,password:``,clear_password:!1,from:e.data.smtp.from,starttls:e.data.smtp.starttls,initial_backlog_hours:e.data.initial_backlog_hours},!0)}catch(e){F(Nt,e instanceof Z?e.message:String(e),!0)}}async function Lt(){F(jt,!0),F(Mt,``),F(Nt,``);try{let e={smtp:{host:V(kt).host.trim(),port:Number(V(kt).port)||0,username:V(kt).username.trim(),from:V(kt).from.trim(),starttls:!!V(kt).starttls},initial_backlog_hours:Math.max(0,Number(V(kt).initial_backlog_hours)||0)};V(kt).clear_password?e.smtp.clear_password=!0:V(kt).password&&(e.smtp.password=V(kt).password),F(At,(await $.setAdminSettings(e)).data,!0),V(kt).password=``,V(kt).clear_password=!1,F(Mt,`Saved`)}catch(e){F(Nt,e instanceof Z?e.message:String(e),!0)}finally{F(jt,!1),setTimeout(()=>F(Mt,``),3e3)}}async function Rt(){F(Ft,!0),F(Mt,``),F(Nt,``);try{F(Mt,`Test sent to ${(await $.testEmail(V(Pt).trim()||void 0)).data.sent_to}`)}catch(e){F(Nt,e instanceof Z?e.message:String(e),!0)}finally{F(Ft,!1),setTimeout(()=>F(Mt,``),4e3)}}let zt=P(``),Bt=P(``),Vt=P(``),Ht=P(!1),Ut=P(``),Wt=P(``);async function Gt(){if(F(Ut,``),F(Wt,``),V(Bt)!==V(Vt)){F(Wt,`passwords do not match`);return}if(V(Bt).length<8){F(Wt,`new password must be at least 8 characters`);return}F(Ht,!0);try{await $.changePassword(V(zt),V(Bt)),F(Ut,`Password changed.`),F(zt,``),F(Bt,``),F(Vt,``)}catch(e){F(Wt,e instanceof Z?e.message:String(e),!0)}finally{F(Ht,!1),setTimeout(()=>F(Ut,``),4e3)}}Vn(()=>{typeof localStorage>`u`||(localStorage.setItem(`ember:theme`,a()),localStorage.setItem(`ember:density`,o()))});function Kt(){s()&&navigator.clipboard?.writeText(s()).catch(()=>{})}let qt=Qt(()=>typeof location<`u`?`${location.origin}/fever`:``),Jt=P(!1),Yt=P(hn([])),Xt=P(``),Zt=P(``),$t=P(``),en=P(``),tn=P(``),nn=P(``),rn=P(!1);async function an(){F(Xt,``);try{F(Yt,(await $.listUsers()).data??[],!0)}catch(e){F(Xt,e instanceof Z?e.message:String(e),!0)}}async function on(){if(!V(en).trim()||!V(nn).trim()){F(Xt,`username and password required`);return}F($t,`create`),F(Xt,``),F(Zt,``);try{await $.createUser({username:V(en).trim(),email:V(tn).trim()||void 0,password:V(nn),is_admin:V(rn)}),F(en,``),F(tn,``),F(nn,``),F(rn,!1),await an(),F(Zt,`User created`)}catch(e){F(Xt,e instanceof Z?e.message:String(e),!0)}finally{F($t,``),setTimeout(()=>F(Zt,``),3e3)}}async function sn(e){let t=!e.is_admin;F($t,`admin:${e.id}`),F(Xt,``);try{await $.updateUser(e.id,{is_admin:t}),F(Yt,V(Yt).map(n=>n.id===e.id?{...n,is_admin:t}:n),!0)}catch(e){F(Xt,e instanceof Z?e.message:String(e),!0)}finally{F($t,``)}}function cn(e){F(p,{title:`Delete user?`,message:`Permanently delete the account "${e.username}". This cannot be undone.`,confirmLabel:`Delete`,destructive:!0,run:()=>ln(e.id)},!0)}async function ln(e){F($t,`delete:${e}`),F(Xt,``);try{await $.deleteUser(e),await an()}catch(e){F(Xt,e instanceof Z?e.message:String(e),!0)}finally{F($t,``)}}function un(){ea(),t.onClose()}var dn=uu(),fn=I(dn);let pn;var mn=I(fn),gn=I(mn),_n=e=>{var t=jc(),n=L(t),r=R(n,2),i=I(r,!0);j(r),z(()=>G(i,V(ce))),H(`click`,n,b),W(e,t)},vn=e=>{W(e,Mc())};K(gn,e=>{V(_)&&V(v)?e(_n):e(vn,-1)});var yn=R(gn,2);j(mn);var bn=R(mn,2),xn=I(bn),Sn=I(xn),Cn=R(I(Sn),2);let wn;var Tn=R(Cn,2);let En;j(Sn);var Dn=R(Sn,2),On=R(I(Dn),2);let kn;var An=R(On,2);let jn;var Mn=R(An,2);let Nn;var Pn=R(Mn,2);let Fn;var In=R(Pn,2);let Ln;j(Dn);var Rn=R(Dn,2),zn=R(I(Rn),2);let Bn;var Hn=R(zn,2);let Un;j(Rn);var Wn=R(Rn,2),Gn=e=>{var t=Nc(),n=R(I(t),2);let r;var i=R(n,2);let a;var o=R(i,2);let s;var c=R(o,2);let l;var u=R(c,2);let d;var f=R(u,2);let p;j(t),z(()=>{r=q(n,1,`svelte-1u3w06f`,null,r,{active:V(g)===`llm`}),a=q(i,1,`svelte-1u3w06f`,null,a,{active:V(g)===`branding`}),s=q(o,1,`svelte-1u3w06f`,null,s,{active:V(g)===`database`}),l=q(c,1,`svelte-1u3w06f`,null,l,{active:V(g)===`session`}),d=q(u,1,`svelte-1u3w06f`,null,d,{active:V(g)===`email`}),p=q(f,1,`svelte-1u3w06f`,null,p,{active:V(g)===`users`})}),H(`click`,n,()=>y(`llm`)),H(`click`,i,()=>y(`branding`)),H(`click`,o,()=>y(`database`)),H(`click`,c,()=>y(`session`)),H(`click`,u,()=>y(`email`)),H(`click`,f,()=>y(`users`)),W(e,t)};K(Wn,e=>{i()?.is_admin&&e(Gn)});var Kn=R(Wn,2),qn=R(I(Kn),2);let Jn;j(Kn),j(xn);var Yn=R(xn,2),Xn=I(Yn),Zn=e=>{var t=Ic(),n=R(L(t),2),r=I(n),a=R(I(r),2);J(a),j(r);var o=R(r,2),s=R(I(o),2);J(s),j(o),j(n);var c=R(n,6),l=e=>{var t=Pc(),n=I(t,!0);j(t),z(()=>G(n,V(Wt))),W(e,t)};K(c,e=>{V(Wt)&&e(l)});var u=R(c,2),d=e=>{var t=Fc(),n=I(t,!0);j(t),z(()=>G(n,V(Ut))),W(e,t)};K(u,e=>{V(Ut)&&e(d)});var f=R(u,2),p=R(I(f),2);J(p),j(f);var m=R(f,2),h=R(I(m),2);J(h),j(m);var g=R(m,2),_=R(I(g),2);J(_),j(g);var v=R(g,2),y=I(v),b=I(y,!0);j(y),j(v),z(()=>{ji(a,i()?.username??``),ji(s,i()?.email??``),y.disabled=V(Ht)||!V(zt)||!V(Bt),G(b,V(Ht)?`Saving…`:`Change password`)}),X(p,()=>V(zt),e=>F(zt,e)),X(h,()=>V(Bt),e=>F(Bt,e)),X(_,()=>V(Vt),e=>F(Vt,e)),H(`click`,y,Gt),W(e,t)};K(Xn,e=>{V(g)===`profile`&&e(Zn)});var Qn=R(Xn,2),$n=e=>{var t=Wc(),n=R(L(t),2),r=e=>{W(e,Lc())},i=e=>{var t=Uc(),n=R(L(t),2),r=e=>{var t=Rc(),n=I(t,!0);j(t),z(()=>G(n,V(ft))),W(e,t)};K(n,e=>{V(ft)&&e(r)});var i=R(n,2),a=e=>{var t=zc(),n=I(t,!0);j(t),z(()=>G(n,V(pt))),W(e,t)};K(i,e=>{V(pt)&&e(a)});var o=R(i,4),s=R(I(o),2);J(s),j(o);var c=R(o,2),l=I(c),u=I(l,!0);j(l),j(c);var d=R(c,4),f=e=>{W(e,Bc())},p=e=>{var t=Hc();li(t,21,()=>V(dt),e=>e.id,(e,t)=>{var n=Vc(),r=I(n),i=I(r),a=I(i,!0);j(i);var o=R(i,2),s=I(o),c=R(s),l=e=>{var n=Qr();z(e=>G(n,`· last used ${e??``}`),[()=>new Date(V(t).last_used_at*1e3).toLocaleDateString()]),W(e,n)};K(c,e=>{V(t).last_used_at&&e(l)}),j(o),j(r);var u=R(r,2);j(n),z(e=>{G(a,V(t).name),G(s,`Added ${e??``} `),u.disabled=V(mt)===`delete:`+V(t).id},[()=>new Date(V(t).created_at*1e3).toLocaleDateString()]),H(`click`,u,()=>bt(V(t))),W(e,n)}),j(t),W(e,t)};K(d,e=>{V(dt).length===0?e(f):e(p,-1)}),z(()=>{l.disabled=V(mt)===`register`,G(u,V(mt)===`register`?`Waiting for device…`:`Register passkey`)}),X(s,()=>V(ht),e=>F(ht,e)),H(`click`,l,yt),W(e,t)};K(n,e=>{ut?e(i,-1):e(r)}),W(e,t)};K(Qn,e=>{V(g)===`passkeys`&&e($n)});var er=R(Qn,2),tr=e=>{var t=qc(),n=R(L(t),2),r=R(I(n),2);li(r,21,()=>ha,e=>e.value,(e,t)=>{var n=Gc();let r;var i=I(n),o=R(i,2),s=I(o,!0);j(o),j(n),z(()=>{r=q(n,1,`theme-tile svelte-1u3w06f`,null,r,{on:a()===V(t).value}),Y(n,`data-mood`,V(t).mood),Y(n,`data-testid`,`theme-${V(t).value??``}`),Y(n,`aria-pressed`,a()===V(t).value),Y(i,`data-theme-preview`,V(t).value),G(s,V(t).label)}),H(`click`,n,()=>ga.set(V(t).value)),W(e,n)}),j(r),j(n);var i=R(n,2),s=e=>{var t=Kc(),n=R(I(t),2),r=I(n),i=R(I(r),2);J(i),j(r);var a=R(r,2),o=R(I(a),2);J(o),j(a);var s=R(a,2),l=R(I(s),2);J(l),j(s);var u=R(s,2),d=R(I(u),2);J(d),j(u),j(n),j(t),X(i,()=>c().paper,e=>vt(ya,Fr(c).paper=e,Fr(c))),X(o,()=>c().ink,e=>vt(ya,Fr(c).ink=e,Fr(c))),X(l,()=>c().ember,e=>vt(ya,Fr(c).ember=e,Fr(c))),X(d,()=>c().link,e=>vt(ya,Fr(c).link=e,Fr(c))),W(e,t)};K(i,e=>{a()===`custom`&&e(s)});var u=R(i,2),d=R(I(u),2),f=I(d);let p;var m=R(f,2);let h;j(d),j(u);var g=R(u,2),_=R(I(g),2),v=I(_);let y;var b=R(v,2);let x;j(_),j(g),z(()=>{p=q(f,1,`svelte-1u3w06f`,null,p,{on:o()===`card`}),h=q(m,1,`svelte-1u3w06f`,null,h,{on:o()===`compact`}),y=q(v,1,`svelte-1u3w06f`,null,y,{on:l()}),x=q(b,1,`svelte-1u3w06f`,null,x,{on:!l()})}),H(`click`,f,()=>Ca.set(`card`)),H(`click`,m,()=>Ca.set(`compact`)),H(`click`,v,()=>Ta.set(!0)),H(`click`,b,()=>Ta.set(!1)),W(e,t)};K(er,e=>{V(g)===`preferences`&&e(tr)});var nr=R(er,2),rr=e=>{var t=Jc(),n=R(L(t),4),r=R(I(n),2);J(r),j(n);var i=R(n,2),a=R(I(i),2);J(a),j(i);var o=R(i,2),c=I(o);j(o),z(()=>{ji(r,V(qt)),ji(a,s())}),H(`click`,c,Kt),W(e,t)};K(nr,e=>{V(g)===`mobile`&&e(rr)});var ir=R(nr,2),ar=e=>{var t=Yc(),n=R(L(t),4),r=I(n);j(n),H(`click`,r,()=>F(Jt,!0)),W(e,t)};K(ir,e=>{V(g)===`filters`&&e(ar)});var or=R(ir,2),sr=e=>{var t=tl(),n=R(L(t),2),r=e=>{var t=Xc(),n=I(t,!0);j(t),z(()=>G(n,V(ge))),W(e,t)};K(n,e=>{V(ge)&&e(r)});var i=R(n,2),a=e=>{W(e,Zc())},o=e=>{var t=el(),n=L(t),r=I(n),i=I(r),a=I(i,!0);j(i),Ie(2),j(r);var o=R(r,2),s=I(o),c=I(s,!0);j(s),Ie(2),j(o);var l=R(o,2),u=I(l),d=I(u,!0);j(u),Ie(2),j(l);var f=R(l,2),p=I(f),m=I(p,!0);j(p),Ie(2),j(f);var h=R(f,2),g=I(h),_=I(g,!0);j(g),Ie(2),j(h);var v=R(h,2),y=I(v),b=I(y,!0);j(y),Ie(2),j(v),j(n);var x=R(n,2),S=e=>{var t=$c(),n=R(L(t),2),r=R(I(n));li(r,21,()=>V(he).top_feeds,e=>e.feed_id,(e,t)=>{var n=Qc(),r=I(n),i=I(r,!0);j(r);var a=R(r),o=I(a,!0);j(a),j(n),z(()=>{G(i,V(t).title),G(o,V(t).read_count)}),W(e,n)}),j(r),j(n),W(e,t)};K(x,e=>{V(he).top_feeds&&V(he).top_feeds.length>0&&e(S)}),z(()=>{G(a,V(he).articles_read_today),G(c,V(he).articles_read_week),G(d,V(he).articles_read_month),G(m,V(he).starred_total),G(_,V(he).later_total),G(b,V(he).subscriptions)}),W(e,t)};K(i,e=>{V(he)?e(o,-1):e(a)}),W(e,t)};K(or,e=>{V(g)===`stats`&&e(sr)});var cr=R(or,2),lr=e=>{var t=ol(),n=R(L(t),4),r=e=>{var t=nl(),n=I(t,!0);j(t),z(()=>G(n,V(ue))),W(e,t)};K(n,e=>{V(ue)&&e(r)});var i=R(n,2),a=e=>{var t=rl(),n=I(t,!0);j(t),z(()=>G(n,V(de))),W(e,t)};K(i,e=>{V(de)&&e(a)});var o=R(i,2),s=e=>{W(e,il())},c=e=>{var t=al(),n=L(t),r=R(I(n),2),i=I(r);let a;var o=R(i,2);let s;j(r),j(n);var c=R(n,2),l=R(I(c),2),u=I(l);u.value=u.__value=`fresh`;var d=R(u);d.value=d.__value=`today`;var f=R(d);f.value=f.__value=`unread`;var p=R(f);p.value=p.__value=`starred`;var m=R(p);m.value=m.__value=`later`,j(l),Ie(2),j(c);var h=R(c,2),g=I(h),_=R(I(g),2);J(_),j(g);var v=R(g,2),y=R(I(v),2);J(y),j(v),j(h);var b=R(h,2),x=R(I(b),2);J(x),j(b);var S=R(b,2),ee=I(S),C=I(ee,!0);j(ee),j(S),z(()=>{a=q(i,1,`svelte-1u3w06f`,null,a,{on:V(le).enabled}),s=q(o,1,`svelte-1u3w06f`,null,s,{on:!V(le).enabled}),ee.disabled=V(fe),G(C,V(fe)?`Saving…`:`Save`)}),H(`click`,i,()=>V(le).enabled=!0),H(`click`,o,()=>V(le).enabled=!1),Ti(l,()=>V(le).view_value,e=>V(le).view_value=e),H(`change`,l,()=>V(le).view_kind=`smart`),X(_,()=>V(le).hour_utc,e=>V(le).hour_utc=e),X(y,()=>V(le).minute_utc,e=>V(le).minute_utc=e),X(x,()=>V(le).email_override,e=>V(le).email_override=e),H(`click`,ee,me),W(e,t)};K(o,e=>{V(le)?e(c,-1):e(s)}),W(e,t)};K(cr,e=>{V(g)===`digest`&&e(lr)});var ur=R(cr,2),dr=e=>{var t=dl(),n=R(L(t),4),r=e=>{var t=sl(),n=I(t,!0);j(t),z(()=>G(n,V(re))),W(e,t)};K(n,e=>{V(re)&&e(r)});var i=R(n,2),a=e=>{var t=cl(),n=I(t,!0);j(t),z(()=>G(n,V(T))),W(e,t)};K(i,e=>{V(T)&&e(a)});var o=R(i,2);Bi(o,e=>F(E,e),()=>V(E));var s=R(o,2);Bi(s,e=>F(D,e),()=>V(D));var c=R(s,2),l=R(I(c),4),u=I(l);let d;var f=R(u,2);let p;j(l);var m=R(l,2),h=e=>{var t=ll(),n=L(t),r=R(I(n),2);J(r),j(n);var i=R(n,2),a=R(I(i),2);J(a),j(i);var o=R(i,2),s=R(I(o),2);J(s),j(o);var c=R(o,2),l=I(c),u=I(l);J(u),Ie(),j(l);var d=R(l,2),f=I(d);J(f),Ie(),j(d),j(c);var p=R(c,4),m=I(p),h=I(m,!0);j(m),j(p),z(()=>{r.disabled=V(w),a.disabled=V(w),s.disabled=V(w),u.disabled=V(w),f.disabled=V(w),m.disabled=V(w),G(h,V(w)?`Importing…`:`Start import`)}),X(r,()=>V(S),e=>F(S,e)),X(a,()=>V(ee),e=>F(ee,e)),X(s,()=>V(C),e=>F(C,e)),Ii(u,()=>V(te),e=>F(te,e)),Ii(f,()=>V(ne),e=>F(ne,e)),H(`click`,m,ie),W(e,t)},g=e=>{var t=ul(),n=R(L(t),2),r=I(n);j(n),z(()=>r.disabled=V(w)),H(`click`,r,()=>V(E)?.click()),W(e,t)};K(m,e=>{V(x)===`live`?e(h):e(g,-1)}),j(c);var _=R(c,2),v=R(I(_),4),y=I(v),b=R(y,2);j(v),j(_),z(()=>{d=q(u,1,`svelte-1u3w06f`,null,d,{on:V(x)===`live`}),p=q(f,1,`svelte-1u3w06f`,null,p,{on:V(x)===`file`}),y.disabled=V(w)}),H(`change`,o,ae),H(`change`,s,oe),H(`click`,u,()=>F(x,`live`)),H(`click`,f,()=>F(x,`file`)),H(`click`,y,()=>V(D)?.click()),H(`click`,b,se),W(e,t)};K(ur,e=>{V(g)===`import`&&e(dr)});var fr=R(ur,2),pr=e=>{var t=_l(),n=R(L(t),4),r=e=>{var t=fl(),n=I(t,!0);j(t),z(()=>G(n,V(Re))),W(e,t)};K(n,e=>{V(Re)&&e(r)});var i=R(n,2),a=e=>{var t=pl(),n=I(t,!0);j(t),z(()=>G(n,V(Le))),W(e,t)};K(i,e=>{V(Le)&&e(a)});var o=R(i,2);li(o,21,()=>V(Pe),e=>e.slug,(e,t)=>{let n=Qt(()=>ze(V(t)));var r=gl(),i=I(r),a=I(i),o=I(a),s=R(o);j(a);var c=R(a,2),l=I(c),u=R(l),d=e=>{var n=Qr();z(()=>G(n,`· ${V(t).subscribed??``} subscribed`)),W(e,n)};K(u,e=>{V(t).subscribed>0&&!V(n)&&e(d)}),j(c),j(i);var f=R(i,2),p=e=>{var n=ml(),r=I(n,!0);j(n),z(()=>{n.disabled=V(Fe)===V(t).slug,Y(n,`data-testid`,`starter-remove-${V(t).slug??``}`),G(r,V(Fe)===V(t).slug?`Removing…`:`Remove pack`)}),H(`click`,n,()=>He(V(t).slug)),W(e,n)},m=e=>{var n=hl(),r=I(n,!0);j(n),z(()=>{n.disabled=V(Fe)===V(t).slug,Y(n,`data-testid`,`starter-import-${V(t).slug??``}`),G(r,V(Fe)===V(t).slug?`Adding…`:`Add pack`)}),H(`click`,n,()=>Ve(V(t).slug)),W(e,n)};K(f,e=>{V(n)?e(p):e(m,-1)}),j(r),z(()=>{Si(o,`background:${V(t).color??``}`),G(s,` ${V(t).name??``}`),G(l,`${V(t).feed_urls.length??``} feeds`)}),W(e,r)}),j(o),W(e,t)};K(fr,e=>{V(g)===`starter`&&e(pr)});var B=R(fr,2),mr=e=>{var t=jl(),n=R(L(t),4),r=e=>{var t=vl(),n=I(t,!0);j(t),z(()=>G(n,V(We))),W(e,t)};K(n,e=>{V(We)&&e(r)});var i=R(n,2),a=e=>{var t=yl(),n=I(t,!0);j(t),z(()=>G(n,V(Ge))),W(e,t)};K(i,e=>{V(Ge)&&e(a)});var o=R(i,2),s=e=>{W(e,bl())},c=e=>{W(e,xl())},l=e=>{var t=Al(),n=R(L(t),2),r=R(I(n)),i=I(r,!0);j(r);var a=R(r,3),o=I(a,!0);j(a);var s=R(a,3),c=I(s,!0);j(s);var l=R(s,3),u=I(l,!0);j(l),j(n);var d=R(n,4),f=I(d),p=I(f),m=I(p,!0);j(p);var h=R(p,2),g=I(h,!0);j(h),j(f);var _=R(f,2),v=e=>{var t=Sl();z(e=>t.disabled=e,[()=>V(Ke).startsWith(`switch:`)||V(Ke).startsWith(`pull:`)]),H(`click`,t,()=>Ze(V(Ue).recommended.model)),W(e,t)};K(_,e=>{!V(Ue).recommended.disable_llm&&V(Ue).recommended.model!==V(Ue).current_model&&e(v)}),j(d);var y=R(d,4),b=I(y),x=I(b,!0);j(b),j(y);var S=R(y,4),ee=e=>{var t=Cl(),n=I(t);j(t),z(()=>G(n,`Couldn't list installed models: ${V(Ue).installed_err??``}`)),W(e,t)},C=e=>{W(e,wl())},te=e=>{var t=Ol(),n=R(I(t));li(n,21,()=>V(Ue).installed,e=>e.name,(e,t)=>{var n=Dl(),r=I(n),i=I(r),a=I(i,!0);j(i),j(r);var o=R(r),s=I(o,!0);j(o);var c=R(o),l=I(c),u=e=>{W(e,Tl())},d=e=>{var n=El(),r=L(n),i=I(r,!0);j(r);var a=R(r,2),o=I(a,!0);j(a),z(()=>{r.disabled=V(Ke)!==``,Y(r,`data-testid`,`llm-switch-${V(t).name??``}`),G(i,V(Ke)===`switch:`+V(t).name?`Switching…`:`Use`),a.disabled=V(Ke)!==``,Y(a,`data-testid`,`llm-delete-${V(t).name??``}`),G(o,V(Ke)===`delete:`+V(t).name?`Deleting…`:`Delete`)}),H(`click`,r,()=>Ze(V(t).name)),H(`click`,a,()=>Qe(V(t).name)),W(e,n)};K(l,e=>{V(t).name===V(Ue).current_model?e(u):e(d,-1)}),j(c),j(n),z(e=>{G(a,V(t).name),G(s,e)},[()=>lt(V(t).size_bytes)]),W(e,n)}),j(n),j(t),W(e,t)};K(S,e=>{V(Ue).installed_err?e(ee):!V(Ue).installed||V(Ue).installed.length===0?e(C,1):e(te,-1)});var ne=R(S,6),w=e=>{var t=kl(),n=I(t,!0);j(t),z(()=>G(n,V(it))),W(e,t)};K(ne,e=>{V(it)&&e(w)});var T=R(ne,2),re=I(T),E=I(re),D=R(I(E)),ie=I(D,!0);j(D),j(E);var ae=R(E,2);J(ae),Ie(2),j(re);var oe=R(re,2),se=I(oe),ce=R(I(se)),le=I(ce,!0);j(ce),j(se);var ue=R(se,2);J(ue),Ie(2),j(oe);var de=R(oe,2),fe=I(de),pe=R(I(fe)),me=I(pe,!0);j(pe),j(fe);var he=R(fe,2);J(he),Ie(2),j(de),j(T);var ge=R(T,2),_e=I(ge),O=I(_e,!0);j(_e),j(ge);var ve=R(ge,6),ye=I(ve);J(ye);var be=R(ye,2),xe=I(be,!0);j(be),j(ve),z((e,t,n,r,a)=>{G(i,e),G(o,V(Ue).system.cpus),G(c,V(Ue).system.gpu||`none detected`),G(u,V(Ue).system.os),G(m,V(Ue).recommended.disable_llm?`Disable summaries`:V(Ue).recommended.model),G(g,V(Ue).recommended.reason),G(x,V(Ue).current_model||`(none)`),G(ie,t),G(le,n),G(me,V(nt)||`default`),_e.disabled=V(rt),G(O,V(rt)?`Saving…`:`Save tuning`),be.disabled=r,G(xe,a)},[()=>ct(V(Ue).system.ram_bytes),()=>(+V(et)).toFixed(2),()=>(+V(tt)).toFixed(2),()=>!V(Ye).trim()||V(Ke).startsWith(`pull:`),()=>V(Ke).startsWith(`pull:`)?`Pulling…`:`Pull`]),X(ae,()=>V(et),e=>F(et,e)),X(ue,()=>V(tt),e=>F(tt,e)),X(he,()=>V(nt),e=>F(nt,e)),H(`click`,_e,ot),X(ye,()=>V(Ye),e=>F(Ye,e)),H(`click`,be,st),W(e,t)};K(o,e=>{V(Ue)?V(Ue).enabled?e(l,-1):e(c,1):e(s)}),W(e,t)};K(B,e=>{V(g)===`llm`&&i()?.is_admin&&e(mr)});var hr=R(B,2),gr=e=>{var t=Pl(),n=R(L(t),4),r=e=>{var t=Ml(),n=I(t,!0);j(t),z(()=>G(n,V(je))),W(e,t)};K(n,e=>{V(je)&&e(r)});var i=R(n,2),a=e=>{var t=Nl(),n=I(t,!0);j(t),z(()=>G(n,V(Ae))),W(e,t)};K(i,e=>{V(Ae)&&e(a)});var o=R(i,2),s=R(I(o),2);J(s),j(o);var c=R(o,2),l=R(I(c),2);J(l),j(c);var u=R(c,2),d=R(I(u),2);J(d),Ie(2),j(u);var f=R(u,2),p=I(f),m=R(p,2),h=I(m,!0);j(m),j(f),z(()=>{p.disabled=V(Me),m.disabled=V(Me),G(h,V(Me)?`Saving…`:`Save`)}),X(s,()=>V(ke).name,e=>V(ke).name=e),X(l,()=>V(ke).page_title,e=>V(ke).page_title=e),X(d,()=>V(ke).favicon_url,e=>V(ke).favicon_url=e),H(`click`,p,A),H(`click`,m,Ne),W(e,t)};K(hr,e=>{V(g)===`branding`&&i()?.is_admin&&e(gr)});var _r=R(hr,2),vr=e=>{var t=Vl(),n=R(L(t),2),r=e=>{var t=Fl(),n=I(t,!0);j(t),z(()=>G(n,V(ve))),W(e,t)};K(n,e=>{V(ve)&&e(r)});var i=R(n,2),a=e=>{var t=Il(),n=I(t,!0);j(t),z(()=>G(n,V(ye))),W(e,t)};K(i,e=>{V(ye)&&e(a)});var o=R(i,2),s=e=>{W(e,Ll())},c=e=>{var t=Bl(),n=R(L(t),2),r=R(I(n)),i=I(r,!0);j(r);var a=R(r,3),o=I(a,!0);j(a);var s=R(a,3),c=I(s),l=I(c,!0);j(c),j(s),j(n);var u=R(n,4),d=R(I(u)),f=I(d,!0);j(d),Ie(),j(u);var p=R(u,2),m=I(p),h=I(m,!0);j(m),j(p);var g=R(p,2),_=e=>{var t=zl(),n=R(L(t),2),r=R(I(n));li(r,21,()=>(V(O).backups??[]).slice(0,8),e=>e.path,(e,t)=>{var n=Rl(),r=I(n),i=I(r),a=I(i,!0);j(i),j(r);var o=R(r),s=I(o,!0);j(o);var c=R(o),l=I(c,!0);j(c),j(n),z((e,t,n)=>{G(a,e),G(s,t),G(l,n)},[()=>V(t).path.split(`/`).slice(-1)[0],()=>De(V(t).size_bytes),()=>Oe(V(t).created_at)]),W(e,n)}),j(r),j(n),W(e,t)};K(g,e=>{(V(O).backups?.length??0)>0&&e(_)});var v=R(g,6),y=I(v),b=R(I(y),2);J(b),j(y);var x=R(y,2),S=I(x,!0);j(x),j(v);var ee=R(v,6),C=I(ee),te=R(I(C),2),ne=I(te);j(te),j(C);var w=R(C,2),T=I(w);let re;var E=R(T,2);let D;var ie=R(E,2);let ae;j(w),j(ee);var oe=R(ee,2),se=I(oe),ce=R(I(se),2),le=I(ce);j(ce),j(se);var ue=R(se,2),de=I(ue);let fe;var pe=R(de,2);let me;var he=R(pe,2);let ge;j(ue),j(oe);var _e=R(oe,2),ve=R(I(_e),2),ye=I(ve);let Se;var Te=R(ye,2);let ke;var Ae=R(Te,2);let je;j(ve),j(_e);var Me=R(_e,2),k=I(Me),Ne=R(I(k),2);J(Ne),j(k);var A=R(k,2),Pe=R(I(A),2);J(Pe),j(A),j(Me);var Fe=R(Me,2),Le=I(Fe),Re=I(Le,!0);j(Le),j(Fe),z((e,t)=>{G(i,e),G(o,t),G(l,V(O).backup_dir),G(f,V(O).backup_dir),m.disabled=V(be)===`backup`,G(h,V(be)===`backup`?`Backing up…`:`Back up now`),x.disabled=V(be)===`cleanup`,G(S,V(be)===`cleanup`?`Cleaning…`:`Clean up now`),G(ne,`Keep the ${V(O).backup_keep_count??``} most recent.`),re=q(T,1,`svelte-1u3w06f`,null,re,{on:V(O).backup_schedule===`off`}),D=q(E,1,`svelte-1u3w06f`,null,D,{on:V(O).backup_schedule===`daily`}),ae=q(ie,1,`svelte-1u3w06f`,null,ae,{on:V(O).backup_schedule===`weekly`}),G(le,`Older than ${V(O).cleanup_older_days??``} days, when scheduled.`),fe=q(de,1,`svelte-1u3w06f`,null,fe,{on:V(O).cleanup_schedule===`off`}),me=q(pe,1,`svelte-1u3w06f`,null,me,{on:V(O).cleanup_schedule===`weekly`}),ge=q(he,1,`svelte-1u3w06f`,null,ge,{on:V(O).cleanup_schedule===`monthly`}),Se=q(ye,1,`svelte-1u3w06f`,null,Se,{on:(V(O).opml_schedule||`off`)===`off`}),ke=q(Te,1,`svelte-1u3w06f`,null,ke,{on:V(O).opml_schedule===`weekly`}),je=q(Ae,1,`svelte-1u3w06f`,null,je,{on:V(O).opml_schedule===`monthly`}),Le.disabled=V(be)===`schedule`,G(Re,V(be)===`schedule`?`Saving…`:`Save schedule`)},[()=>De(V(O).size_bytes),()=>V(O).page_count.toLocaleString()]),H(`click`,m,Ce),X(b,()=>V(xe),e=>F(xe,e)),H(`click`,x,we),H(`click`,T,()=>V(O).backup_schedule=`off`),H(`click`,E,()=>V(O).backup_schedule=`daily`),H(`click`,ie,()=>V(O).backup_schedule=`weekly`),H(`click`,de,()=>V(O).cleanup_schedule=`off`),H(`click`,pe,()=>V(O).cleanup_schedule=`weekly`),H(`click`,he,()=>V(O).cleanup_schedule=`monthly`),H(`click`,ye,()=>V(O).opml_schedule=`off`),H(`click`,Te,()=>V(O).opml_schedule=`weekly`),H(`click`,Ae,()=>V(O).opml_schedule=`monthly`),X(Ne,()=>V(O).backup_keep_count,e=>V(O).backup_keep_count=e),X(Pe,()=>V(O).cleanup_older_days,e=>V(O).cleanup_older_days=e),H(`click`,Le,Ee),W(e,t)};K(o,e=>{V(O)?e(c,-1):e(s)}),W(e,t)};K(_r,e=>{V(g)===`database`&&i()?.is_admin&&e(vr)});var yr=R(_r,2),br=e=>{var t=Yl(),n=R(L(t),4),r=e=>{var t=Hl(),n=I(t,!0);j(t),z(()=>G(n,V(Xt))),W(e,t)};K(n,e=>{V(Xt)&&e(r)});var a=R(n,2),o=e=>{var t=Ul(),n=I(t,!0);j(t),z(()=>G(n,V(Zt))),W(e,t)};K(a,e=>{V(Zt)&&e(o)});var s=R(a,4),c=I(s),l=R(I(c),2);J(l),j(c);var u=R(c,2),d=R(I(u),2);J(d),j(u),j(s);var f=R(s,2),p=I(f),m=R(I(p),2);J(m),j(p),j(f);var h=R(f,2),g=R(I(h),2),_=I(g);let v;var y=R(_,2);let b;j(g),j(h);var x=R(h,2),S=I(x),ee=I(S,!0);j(S),j(x);var C=R(x,4),te=e=>{W(e,Wl())},ne=e=>{var t=Jl(),n=R(I(t));li(n,21,()=>V(Yt),e=>e.id,(e,t)=>{var n=ql(),r=I(n),a=I(r),o=I(a,!0);j(a);var s=R(a,2),c=e=>{W(e,Gl())};K(s,e=>{i()?.id===V(t).id&&e(c)}),j(r);var l=R(r),u=I(l,!0);j(l);var d=R(l),f=I(d),p=I(f);let m;var h=R(p,2);let g;j(f),j(d);var _=R(d),v=I(_),y=e=>{var n=Kl(),r=I(n,!0);j(n),z(()=>{n.disabled=V($t)===`delete:${V(t).id}`,Y(n,`data-testid`,`user-delete-${V(t).id??``}`),G(r,V($t)===`delete:${V(t).id}`?`Deleting…`:`Delete`)}),H(`click`,n,()=>cn(V(t))),W(e,n)};K(v,e=>{i()?.id!==V(t).id&&e(y)}),j(_),j(n),z(()=>{Y(n,`data-testid`,`user-row-${V(t).id??``}`),G(o,V(t).username),G(u,V(t).email||`—`),p.disabled=V($t)===`admin:${V(t).id}`||i()?.id===V(t).id,Y(p,`data-testid`,`user-admin-yes-${V(t).id??``}`),Y(p,`title`,i()?.id===V(t).id?`Cannot change your own admin status`:``),m=q(p,1,`svelte-1u3w06f`,null,m,{on:V(t).is_admin}),h.disabled=V($t)===`admin:${V(t).id}`||i()?.id===V(t).id,Y(h,`data-testid`,`user-admin-no-${V(t).id??``}`),Y(h,`title`,i()?.id===V(t).id?`Cannot change your own admin status`:``),g=q(h,1,`svelte-1u3w06f`,null,g,{on:!V(t).is_admin})}),H(`click`,p,()=>sn(V(t))),H(`click`,h,()=>sn(V(t))),W(e,n)}),j(n),j(t),W(e,t)};K(C,e=>{V(Yt).length===0?e(te):e(ne,-1)}),z(()=>{v=q(_,1,`svelte-1u3w06f`,null,v,{on:V(rn)}),b=q(y,1,`svelte-1u3w06f`,null,b,{on:!V(rn)}),S.disabled=V($t)===`create`,G(ee,V($t)===`create`?`Creating…`:`Create user`)}),X(l,()=>V(en),e=>F(en,e)),X(d,()=>V(tn),e=>F(tn,e)),X(m,()=>V(nn),e=>F(nn,e)),H(`click`,_,()=>F(rn,!0)),H(`click`,y,()=>F(rn,!1)),H(`click`,S,on),W(e,t)};K(yr,e=>{V(g)===`users`&&i()?.is_admin&&e(br)});var xr=R(yr,2),Sr=e=>{var t=eu(),n=R(L(t),4),r=e=>{var t=Xl(),n=I(t,!0);j(t),z(()=>G(n,V(wt))),W(e,t)};K(n,e=>{V(wt)&&e(r)});var i=R(n,2),a=e=>{var t=Zl(),n=I(t,!0);j(t),z(()=>G(n,V(Ct))),W(e,t)};K(i,e=>{V(Ct)&&e(a)});var o=R(i,2),s=e=>{var t=Ql(),n=I(t),r=R(n),i=I(r);j(r),j(t),z(e=>{G(n,`Active TTL: ${e??``}h `),G(i,`(${V(N).source===`admin`?`set in admin UI`:`default / env var`})`)},[()=>Math.round(V(N).ttl_seconds/3600)]),W(e,t)};K(o,e=>{V(N)&&e(s)});var c=R(o,2),l=R(I(c),2);li(l,21,()=>Ot,ai,(e,t)=>{var n=$l(),r=I(n,!0);j(n);var i={};z(()=>{G(r,V(t).label),i!==(i=V(t).seconds)&&(n.value=(n.__value=V(t).seconds)??``)}),W(e,n)}),j(l),j(c);var u=R(c,2),d=R(I(u),2);J(d),j(u);var f=R(u,2),p=I(f),m=I(p,!0);j(p),j(f),z(()=>{p.disabled=V(Tt),G(m,V(Tt)?`Saving…`:`Save`)}),Ti(l,()=>V(St),e=>F(St,e)),X(d,()=>V(St),e=>F(St,e)),H(`click`,p,Dt),W(e,t)};K(xr,e=>{V(g)===`session`&&i()?.is_admin&&e(Sr)});var Cr=R(xr,2),wr=e=>{var t=ou(),n=R(L(t),4),r=I(n),i=R(I(r));J(i),j(r);var a=R(r,2),o=R(I(a));J(o),j(a);var s=R(a,2),c=R(I(s));J(c),j(s);var l=R(s,2),u=R(I(l)),d=e=>{var t=tu();J(t),X(t,()=>V(kt).password,e=>V(kt).password=e),W(e,t)},f=e=>{var t=nu();J(t),X(t,()=>V(kt).password,e=>V(kt).password=e),W(e,t)};K(u,e=>{V(At)?.smtp.password_set&&!V(kt).password&&!V(kt).clear_password?e(d):e(f,-1)}),j(l);var p=R(l,2),m=R(I(p));J(m),j(p),j(n);var h=R(n,2),g=R(I(h),2),_=I(g);J(_),Ie(2),j(g),j(h);var v=R(h,2),y=e=>{var t=ru(),n=I(t);J(n),Ie(),j(t),Ii(n,()=>V(kt).clear_password,e=>V(kt).clear_password=e),W(e,t)};K(v,e=>{V(At)?.smtp.password_set&&e(y)});var b=R(v,2),x=e=>{var t=iu(),n=I(t,!0);j(t),z(()=>G(n,V(Mt))),W(e,t)};K(b,e=>{V(Mt)&&e(x)});var S=R(b,2),ee=e=>{var t=au(),n=I(t,!0);j(t),z(()=>G(n,V(Nt))),W(e,t)};K(S,e=>{V(Nt)&&e(ee)});var C=R(S,2),te=I(C),ne=I(te,!0);j(te),j(C);var w=R(C,8),T=I(w),re=R(I(T));J(re),j(T);var E=R(T,2),D=I(E,!0);j(E),j(w);var ie=R(w,8),ae=R(I(ie));J(ae),j(ie);var oe=R(ie,2),se=I(oe),ce=I(se,!0);j(se),j(oe),z(()=>{te.disabled=V(jt),G(ne,V(jt)?`Saving…`:`Save`),E.disabled=V(Ft),G(D,V(Ft)?`Sending…`:`Send test`),se.disabled=V(jt),G(ce,V(jt)?`Saving…`:`Save`)}),X(i,()=>V(kt).host,e=>V(kt).host=e),X(o,()=>V(kt).port,e=>V(kt).port=e),X(c,()=>V(kt).username,e=>V(kt).username=e),X(m,()=>V(kt).from,e=>V(kt).from=e),Ii(_,()=>V(kt).starttls,e=>V(kt).starttls=e),H(`click`,te,Lt),X(re,()=>V(Pt),e=>F(Pt,e)),H(`click`,E,Rt),X(ae,()=>V(kt).initial_backlog_hours,e=>V(kt).initial_backlog_hours=e),H(`click`,se,Lt),W(e,t)};K(Cr,e=>{V(g)===`email`&&i()?.is_admin&&e(wr)});var Tr=R(Cr,2),Er=e=>{var t=lu(),n=R(L(t),2),r=R(I(n),2),i=I(r),a=e=>{let t=Qt(()=>u().split(`-`)[0]);var n=su(),r=I(n,!0);j(n),z(()=>{Y(n,`href`,`https://github.com/brandonhon/ember/releases/tag/${V(t)}`),G(r,u())}),W(e,n)},o=Qt(()=>u().startsWith(`v`)),s=e=>{var t=cu(),n=I(t,!0);j(t),z(()=>G(n,u())),W(e,t)};K(i,e=>{V(o)?e(a):e(s,-1)}),j(r),Ie(6),j(n),W(e,t)};K(Tr,e=>{V(g)===`about`&&e(Er)}),j(Yn),j(bn),j(fn);var Dr=R(fn,2),Or=e=>{Ac(e,{onClose:()=>F(Jt,!1)})};K(Dr,e=>{V(Jt)&&e(Or)});var kr=R(Dr,2),Ar=e=>{{let t=Qt(()=>V(p).confirmLabel??`Confirm`),n=Qt(()=>V(p).destructive??!1);Co(e,{get title(){return V(p).title},get message(){return V(p).message},get confirmLabel(){return V(t)},get destructive(){return V(n)},get busy(){return V(m)},onConfirm:h,onCancel:()=>F(p,null)})}};K(kr,e=>{V(p)&&e(Ar)}),j(dn),z(()=>{pn=q(fn,1,`modal svelte-1u3w06f`,null,pn,{mobile:V(_)}),Y(bn,`data-view`,V(_)?V(v)?`detail`:`list`:`split`),wn=q(Cn,1,`svelte-1u3w06f`,null,wn,{active:V(g)===`profile`}),En=q(Tn,1,`svelte-1u3w06f`,null,En,{active:V(g)===`passkeys`}),kn=q(On,1,`svelte-1u3w06f`,null,kn,{active:V(g)===`preferences`}),jn=q(An,1,`svelte-1u3w06f`,null,jn,{active:V(g)===`filters`}),Nn=q(Mn,1,`svelte-1u3w06f`,null,Nn,{active:V(g)===`digest`}),Fn=q(Pn,1,`svelte-1u3w06f`,null,Fn,{active:V(g)===`stats`}),Ln=q(In,1,`svelte-1u3w06f`,null,Ln,{active:V(g)===`mobile`}),Bn=q(zn,1,`svelte-1u3w06f`,null,Bn,{active:V(g)===`import`}),Un=q(Hn,1,`svelte-1u3w06f`,null,Un,{active:V(g)===`starter`}),Jn=q(qn,1,`svelte-1u3w06f`,null,Jn,{active:V(g)===`about`})}),H(`click`,yn,un),H(`click`,Cn,()=>y(`profile`)),H(`click`,Tn,()=>y(`passkeys`)),H(`click`,On,()=>y(`preferences`)),H(`click`,An,()=>y(`filters`)),H(`click`,Mn,()=>y(`digest`)),H(`click`,Pn,()=>y(`stats`)),H(`click`,In,()=>y(`mobile`)),H(`click`,zn,()=>y(`import`)),H(`click`,Hn,()=>y(`starter`)),H(`click`,qn,()=>y(`about`)),H(`click`,fn,Vi(function(e){Wi.call(this,t,e)})),H(`click`,dn,un),W(e,dn),Je(),f()}var fu=U(`<div class="backdrop svelte-1et61ur" role="dialog" aria-modal="true" aria-labelledby="welcome-title" data-testid="welcome-modal"><div class="card svelte-1et61ur"><header class="svelte-1et61ur"><h2 id="welcome-title" class="svelte-1et61ur">Welcome to Ember</h2> <button class="close svelte-1et61ur" aria-label="Close">×</button></header> <p class="svelte-1et61ur">Ember is your self-hosted reader. Start by adding feeds — pick a curated
      pack to subscribe in one click, paste a feed URL into the sidebar <strong>+ Add feed</strong> button, or import an OPML file from another reader.</p> <div class="actions svelte-1et61ur"><button class="primary svelte-1et61ur" data-testid="welcome-browse">Browse starter packs</button> <a class="docs-link svelte-1et61ur" href="https://brandonhon.github.io/ember/getting-started" target="_blank" rel="noopener" data-testid="welcome-docs">Read the docs ↗</a></div></div></div>`);function pu(e,t){qe(t,!0);function n(){location.hash=`#starter`,window.dispatchEvent(new CustomEvent(`ember:open-settings`,{detail:`starter`})),t.onClose()}function r(e){e.key===`Escape`&&(e.preventDefault(),t.onClose())}Ki(()=>window.addEventListener(`keydown`,r)),qi(()=>window.removeEventListener(`keydown`,r));var i=fu(),a=I(i),o=I(a),s=R(I(o),2);j(o);var c=R(o,4),l=I(c);Ie(2),j(c),j(a),j(i),H(`click`,s,function(...e){t.onClose?.apply(this,e)}),H(`click`,l,n),H(`click`,a,Vi(function(e){Wi.call(this,t,e)})),H(`click`,i,function(...e){t.onClose?.apply(this,e)}),W(e,i),Je()}We();var mu=U(`<div class="demo-banner svelte-y0mbvj" role="note" aria-label="Demo mode"><span class="dot svelte-y0mbvj" aria-hidden="true"></span> <span class="txt svelte-y0mbvj"><strong>Demo mode</strong> <span class="muted svelte-y0mbvj"> </span></span> <a class="cta svelte-y0mbvj">Self-host&nbsp;→</a></div>`);function hu(e,t){qe(t,!1);let n=`/ember/demo/`.replace(/demo\/?$/,``)||`/`;Hi();var r=mu(),i=R(I(r),2),a=R(I(i),2),o=I(a);j(a),j(i);var s=R(i,2);j(r),z(()=>{G(o,`— data frozen${co?` as of ${co}`:``}; changes reset on reload`),Y(s,`href`,n)}),W(e,r),Je()}var gu=U(`<div class="dn-scrim svelte-1whqzth" role="presentation"><div class="dn-card svelte-1whqzth" role="dialog" aria-modal="true" aria-label="Demo notice"><div class="dn-mark svelte-1whqzth" aria-hidden="true">✦</div> <h2 class="svelte-1whqzth">This is a live demo</h2> <p class="svelte-1whqzth">You're browsing a frozen snapshot — reading, starring and searching work,
        but changes aren't saved and management actions are disabled.</p> <p class="muted svelte-1whqzth">Self-host Ember to add your own feeds, run the AI summaries, and keep everything.</p> <div class="dn-actions svelte-1whqzth"><button class="dn-secondary svelte-1whqzth" type="button">Keep exploring</button> <a class="dn-primary svelte-1whqzth">Self-host Ember →</a></div></div></div>`);function _u(e,t){qe(t,!1);let n=()=>M(ao,`$demoNotice`,r),[r,i]=gt(),a=`/ember/demo/`.replace(/demo\/?$/,``)||`/`;function o(){ao.set(!1)}Hi();var s=$r(),c=L(s),l=e=>{var n=gu(),r=I(n),i=R(I(r),8),s=I(i),c=R(s,2);j(i),j(r),j(n),z(()=>Y(c,`href`,a)),H(`click`,s,o),H(`click`,r,Vi(function(e){Wi.call(this,t,e)})),H(`click`,n,o),W(e,n)};K(c,e=>{n()&&e(l)}),W(e,s),Je(),i()}var vu=U(`<!> <!>`,1),yu=U(`<p class="boot svelte-1n46o8q">Loading…</p>`),bu=U(`<div class="mobile-scrim svelte-1n46o8q" role="presentation"></div>`),xu=U(`<!> <div><!></div> <!>`,1),Su=U(`<!> <!> <!>`,1),Cu=U(`<div><!> <div><!></div></div> <!> <!> <!>`,1),wu=U(`<!> <!>`,1);function Tu(e,t){qe(t,!0);let n=()=>M(Xi,`$user`,u),r=()=>M(xa,`$branding`,u),i=()=>M(Aa,`$newArticleCount`,u),a=()=>M(pa,`$selectedArticleId`,u),o=()=>M(ga,`$theme`,u),s=()=>M(ya,`$customPalette`,u),c=()=>M(wa,`$sidebarCollapsed`,u),l=()=>M(ra,`$feeds`,u),[u,d]=gt(),f=()=>{},p=P(!1),m=P(!1),h=P(!1),g=`ember:welcome-seen`,_=P(!1),v=P(!1);function y(e){let t=ft(Oa).items;if(t.length===0)return;let n=ft(pa),r=n===null?-1:t.findIndex(e=>e.id===n),i=Math.max(0,Math.min(t.length-1,r+e));pa.set(t[i].id)}function b(){let e=ft(pa);return e===null?null:ft(Oa).items.find(t=>t.id===e)??null}function x(e){switch(e){case`next`:y(1);return;case`prev`:y(-1);return;case`toggle-read`:{let e=b();e&&Na([e.id],!e.is_read);return}case`toggle-star`:{let e=b();e&&Pa(e.id,!e.is_starred);return}case`open-original`:{let e=b();e?.url&&window.open(e.url,`_blank`,`noopener,noreferrer`);return}case`refresh`:la(),Ma(ft(fa));return;case`focus-search`:document.querySelector(`input[data-testid="search-input"]`)?.focus();return;case`show-help`:F(m,!0);return}}function S(){Xi.set(null)}function ee(){F(h,!0)}let C=null;function te(){ne(),C=setInterval(()=>{document.hidden||(ja(),ft(ca).pending_summary>0&&ua())},15e3)}function ne(){C&&=(clearInterval(C),null)}function w(){document.hidden||ja()}Ki(async()=>{f=Ra(x),window.addEventListener(`ember:unauthorized`,S),window.addEventListener(`ember:open-settings`,ee),document.addEventListener(`visibilitychange`,w);try{F(_,localStorage.getItem(g)===`1`)}catch{}Sa();try{await ea()}catch{}F(p,!0)});function T(){F(_,!0);try{localStorage.setItem(g,`1`)}catch{}}qi(()=>{f(),window.removeEventListener(`ember:unauthorized`,S),window.removeEventListener(`ember:open-settings`,ee),document.removeEventListener(`visibilitychange`,w),ne()});let re=P(null);Vn(()=>{n()&&n().id!==V(re)?(F(re,n().id,!0),la().then(()=>{F(v,!0)}),Ma(ft(fa)),te()):n()||(F(re,null),F(v,!1),ne())});let E=P(hn(typeof window<`u`&&window.matchMedia?.(`(prefers-color-scheme: dark)`).matches));Vn(()=>{if(typeof window>`u`)return;let e=window.matchMedia(`(prefers-color-scheme: dark)`),t=e=>F(E,e.matches,!0);return e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)}),Vn(()=>{let e=document.querySelector(`link[rel="icon"]`);e&&Ya(r().favicon_url?r().favicon_url:V(E)?`/ember/demo/icon-dark.svg`:`/ember/demo/icon.svg`,i()>0).then(t=>{t.startsWith(`data:image/png`)&&e.removeAttribute(`type`),e.href=t})}),Vn(()=>{let e=r().page_title||r().name||`Ember`;document.title=i()>0?`(${i()}) ${e}`:e}),Vn(()=>{if(typeof navigator>`u`)return;let e=navigator;i()>0&&typeof e.setAppBadge==`function`?e.setAppBadge(i()).catch(()=>{}):typeof e.clearAppBadge==`function`&&e.clearAppBadge().catch(()=>{})});let D=P(hn(typeof window<`u`&&window.matchMedia?.(`(prefers-color-scheme: dark)`).matches)),ie=P(hn(typeof window<`u`&&window.matchMedia?.(`(max-width: 900px)`).matches));Vn(()=>{if(typeof window>`u`)return;let e=window.matchMedia(`(max-width: 900px)`),t=e=>F(ie,e.matches,!0);return e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)});let ae=P(!1),oe=Qt(()=>a()===null?`list`:`reader`);function se(){pa.set(null)}Vn(()=>{if(typeof window>`u`)return;let e=window.matchMedia(`(prefers-color-scheme: dark)`),t=e=>F(D,e.matches,!0);return e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)}),Vn(()=>{let e=o()===`auto`?V(D)?`dark`:`light`:o();document.documentElement.dataset.theme=e;try{localStorage.setItem(`ember:theme`,o())}catch{}}),Vn(()=>{if(o()!==`custom`){document.documentElement.style.removeProperty(`--paper`),document.documentElement.style.removeProperty(`--ink`),document.documentElement.style.removeProperty(`--ember`),document.documentElement.style.removeProperty(`--link`);return}document.documentElement.style.setProperty(`--paper`,s().paper),document.documentElement.style.setProperty(`--ink`,s().ink),document.documentElement.style.setProperty(`--ember`,s().ember),s().link?document.documentElement.style.setProperty(`--link`,s().link):document.documentElement.style.removeProperty(`--link`)});var ce=wu(),le=L(ce),ue=e=>{var t=vu(),n=L(t);hu(n,{}),_u(R(n,2),{}),W(e,t)};K(le,e=>{e(ue)});var de=R(le,2),fe=e=>{W(e,yu())},pe=e=>{xo(e,{})},me=e=>{var t=Cu(),r=L(t);let i;var a=I(r);{let e=Qt(()=>V(ie)&&V(oe)===`reader`);yc(a,{onOpenSettings:()=>F(h,!0),get mobile(){return V(ie)},onToggleMobileSidebar:()=>F(ae,!V(ae)),get showBack(){return V(e)},onBack:se})}var s=R(a,2);let u;var d=I(s),f=e=>{var t=xu(),n=L(t),r=e=>{var t=bu();H(`click`,t,()=>F(ae,!1)),W(e,t)};K(n,e=>{V(ae)&&e(r)});var i=R(n,2);let a;ns(I(i),{}),j(i);var o=R(i,2),s=e=>{vs(e,{})},c=e=>{ec(e,{})};K(o,e=>{V(oe)===`list`?e(s):e(c,-1)}),z(()=>a=q(i,1,`mobile-drawer svelte-1n46o8q`,null,a,{open:V(ae)})),W(e,t)},p=e=>{var t=Su(),n=L(t),r=e=>{ns(e,{})};K(n,e=>{c()||e(r)});var i=R(n,2);vs(i,{}),ec(R(i,2),{}),W(e,t)};K(d,e=>{V(ie)?e(f):e(p,-1)}),j(s),j(r);var g=R(r,2),y=e=>{Sc(e,{onClose:()=>F(m,!1)})};K(g,e=>{V(m)&&e(y)});var b=R(g,2),x=e=>{du(e,{onClose:()=>F(h,!1)})};K(b,e=>{V(h)&&e(x)});var S=R(b,2),ee=e=>{pu(e,{onClose:T})};K(S,e=>{n()&&V(v)&&l().length===0&&!V(_)&&e(ee)}),z(()=>{i=q(r,1,`shell svelte-1n46o8q`,null,i,{mobile:V(ie)}),Y(r,`data-theme`,o()),u=q(s,1,`panes svelte-1n46o8q`,null,u,{"sidebar-collapsed":c(),mobile:V(ie),"drawer-open":V(ie)&&V(ae)}),Y(s,`data-mobile-pane`,V(oe))}),W(e,t)};K(de,e=>{V(p)?n()?e(me,-1):e(pe,1):e(fe)}),W(e,ce),Je(),d()}_o();var Eu=document.getElementById(`app`);if(!Eu)throw Error(`missing #app root`);ei(Tu,{target:Eu});